...
<table width="300" border="0" >
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv2" type="text" size="10" pattern="[0-9]+" id="adv2"   class="advance" onchange=" pass_validation(); generate_cr('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec'); diff('grand_tot','tot_rec','net');"/></div></td>
 ...
 <th><div align="justify">Total Recieved</div></th>
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3"   class="advance" onchange=" pass_validation(); generate_cr('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec'); diff('grand_tot','tot_rec','net');"/></div></td>
...
<table width="252" border="0" >
  ...
  <th><div align="justify">Mineral Water</div></th>
   ...
   <tr>
  <th height="24"><div align="justify">Table Setting</div></th>
    <td><div align="justify"><input name="tset" type="text" size="5" id="op8" pattern="[0-9]+" onchange="calc('op8','op9','result4'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tableset_no']; ?>"/></div></td>
    <th width="27"><div align="justify">Rate:</div></th>
    <td width="40"><div align="justify"><input name="tset_rate" type="text" size="5" pattern="[0-9]+" id="op9" onchange="calc('op8','op9','result4'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tableset_rate']; ?>"/></div></td>
    <td width="86"><div align="right">
...
$result22= mysql_query($query22) or die('Selection Failed:'.mysql_error());	
  ...
  ?>
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv2" type="text" size="10"  pattern="[0-9]+" id="adv2"  class="advance" onchange=" pass_validation(); generate_cr('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row22['INSTALMENT_AMOUNT']; ?>"/></div></td>
...
$result23= mysql_query($query23) or die('Selection Failed:'.mysql_error());	
  ...
  ?>
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3"  class="advance" onchange=" pass_validation(); generate_cr('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row23['INSTALMENT_AMOUNT']; ?>"/></div></td>
