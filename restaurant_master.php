...
<head>
  ...
  <SCRIPT LANGUAGE="JavaScript">
    function validate() {
      if (document.new_restaurant.name.value.length < 1) {
        alert("Please enter Name Field .");
        return false;
      }
      if (document.new_restaurant.address.value.length < 1) {
        alert("Please enter Address Field .");
        return false;
      }
      if (document.new_restaurant.city.value.length < 1) {
        alert("Please enter Ciry Field .");
        return false;
      }
      if (document.new_restaurant.landline1.value.length < 1) {
        alert("Please enter LandLine 1 Field .");
        return false;
      }
      if (document.new_restaurant.landline2.value.length < 1) {
        alert("Please enter LandLine 2 Field .");
        return false;
      }
      if (document.new_restaurant.mobile_no.value.length < 1) {
        alert("Please enter Mobile No  Field .");
        return false;
      }
      if (document.new_restaurant.email.value.length < 1) {
  ...
  <div id="templatemo_container">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_middle_column">
        ...
        <h1 class="style1" style="font-size:16px;"><strong>New Restaurant</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>

        <?php
        if (isset($_POST['submit'])) {

          $query = "SELECT max(REST_ID) AS max_rest_id FROM restaurant_master_tab";
          $result = mysqli_query($conn, $query) or die('Query Failed: ' . mysqli_error($conn));
          $row = mysqli_fetch_assoc($result);
          $rest_id = $row['max_rest_id'] ?? 0;
          $rest_id++;

          //$time = date('H:i:s');
          //$date_time = date('Y-m-d H:i:s');
          $created_id = $_SESSION['username'];
          $date_time = date('Y-m-d H:i:s'); // Make sure $date_time is defined

          $name = mysqli_real_escape_string($conn, $_POST['name']);
          $address = mysqli_real_escape_string($conn, $_POST['address']);
          $city = mysqli_real_escape_string($conn, $_POST['city']);
          $landline1 = mysqli_real_escape_string($conn, $_POST['landline1']);
          $landline2 = mysqli_real_escape_string($conn, $_POST['landline2']);
          $mobile_no = mysqli_real_escape_string($conn, $_POST['mobile_no']);
          $email = mysqli_real_escape_string($conn, $_POST['email']);

          $query = "INSERT INTO restaurant_master_tab 
        (REST_ID, NAME, ADDRESS, CITY, LANDLINE1, LANDLINE2, MOBILE_NO, EMAIL, CREATED_ID, CREATED_ON, EDITED_ID, EDITED_ON) 
        VALUES ('$rest_id', '$name', '$address', '$city', '$landline1', '$landline2', '$mobile_no', '$email', '$created_id', '$date_time', '$created_id', '$date_time')";

          mysqli_query($conn, $query) or die('Insertion Failed: ' . mysqli_error($conn));
          echo '<h4 class="style9">Restaurant Successfully Added</h4><br><br>';
        ?>



          <form method="post" action="" id="new_restaurant" name="new_restaurant" onsubmit="return validate();">
            <table width="380" align="center" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="141">Name</td>
                <td width="239"><input type="text" id="name" name="name" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>Address</td>
                <td><textarea rows="2" name="address" id="address" cols="20">
              ...
              <tr>
                <td>LandLine 1</td>
                <td><input type="text" id="landline1" name="landline1" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>LandLine 2</td>
                <td><input type="text" id="landline2" name="landline2" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
