...
<div id="templatemo_middle_column">
  ...
  if (isset($_POST['submit'])) {
    ...
    echo '<h4 class="style9">Dish Successfully Added with the ID </h4>';
...
-->
  ...
  -->
        ...
        <tr>
          <td>Dish ID </td>
          <td><span class="style3"><?php echo $dish_id; ?></span></h1><br></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
    ...
    <form name="dish" method="post" action="" id="dish" onsubmit="return validate();">
      <table width="350" align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <!--  START aLL types of entries  Charges on Date and Charges Off Date Charges Off Date   -->
