...
<head>
	...
	<script type="text/javascript">
		function show_form(value) {
			...
			xmlhttp.open("POST", "ajax/item_edit_form.php", true);
	...
	<script type="text/javascript">
		function edit_item(form) {
			...
			if (item_id == "" || b_forward == "" || reorder == "" || lead_time == "" || inventory_rule == "" || unit_id == "") {
			...
			xmlhttp.open("POST", "ajax/save_edit_item.php", true);
			xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xmlhttp.send("item_id=" + item_id + "&b_forward=" + b_forward + "&reorder=" + reorder + "&lead_time=" + lead_time + "&inventory_rule=" + inventory_rule + "&unit_id=" + unit_id + "&flag=" + flag);
		}
	</script>
	<script type="text/javascript">
		var clicked = false;
	...
	<div id="templatemo_container">
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_middle_column">
				...
				<h1 class="style1" style="font-size:16px;">Edit Item&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1>
				<br>
							...
							<tr>
								...
								<td width="210"><select id="item_id" name="item_id" onchange="show_form(this.value)">
										...
										while ($i < $num) {
											...
											$unit_detail = $row['INGREDIENT_NAME'];
											$unit_id = $row['INGREDIENT_ID'];
										?>
