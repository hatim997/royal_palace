...
?>
<div style="width:1200px; background:#3CF;" id="inventory">
<div style="width:600px; margin-left:10px; border:solid 1px; float:left;">
...
<div id="demand_detail" style="width:580px; border:solid 1px; float:right; height:200px;">
