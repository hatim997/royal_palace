    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_left_column">
        <h2 style="font-size:18px;">
          <BLINK>&nbsp;&nbsp;<?php echo $_SESSION['logoname1']; ?></BLINK>
        </h2>
        <h2>
          <BLINK>&nbsp;&nbsp;<?php echo $_SESSION['logoname2']; ?></BLINK>
        </h2>
        ...
        <div id="none">
          ...
          if (isset($_POST['update'])) {
            ...
            while ($i < $num) {
              ...
              $period = $row['PERIOD_IN_DAYS'];
              $charges = $row['PLAN_CHARGES'];
              $i++;
            }
            ...
            while ($i < $num) {
              mysqli_data_seek($result, $i);
              $row = mysqli_fetch_assoc($result);
              $counter = $row['FREE_TRIAL_COUNTER'];
              $i++;
            }
            ...
            if ($counter >= 2 && $charges == 0) {
              ...
              $que = "UPDATE firm_tab SET 
        FIRM_ID = '$firm_id', 
        FIRM_NAME = '$firm_name', 
        LOGO_NAME1 = '$logo1', 
        LOGO_NAME2 = '$logo2',
        FIRM_OWNER = '$owner', 
        FIRM_OWNER_CNIC = '$cnic', 
        FIRM_ADDRESS = '$address', 
        MEMBERSHIP_DATE = '$current_date', 
        MEMBERSHIP_STATUS = '$status', 
        MEMBERSHIP_FLAG = '$user_type', 
        MEMBERSHIP_EXPIRY = '$expiry', 
        FREE_TRIAL_COUNTER = '$counter', 
        FIXED_LINE1 = '$fixed_line1', 
        FIXED_LINE2 = '$fixed_line2', 
        MOBILE_NO1 = '$cell1', 
        MOBILE_NO2 = '$cell2', 
        EMAIL_ADDRESS = '$email', 
        FIRM_WEBSITE_ADDRESS = '$website', 
        REFERRED_BY = '$refer', 
        LAST_PAY_AMOUNT = '$recieved', 
        LAST_PAY_DATE = '$current_date', 
        EDITED_ID = '$userid', 
        EDITED_ON = '$date_time' 
        WHERE FIRM_ID = '$old_id'";

              mysqli_query($conn, $que) or die('Update failed! ' . mysqli_error($conn));
        ...
        VALUES('$firm_id','$plan', '$charges', '$discount', '$recieved', '$current_date', '$userid', '$date_time', '$userid', '$date_time')";
            ...
            <table width="80%" border="0" align="left" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="55%" align="left">Search Type:&nbsp;&nbsp;&nbsp;
                        ...
                        <input class="button" align="left" onclick="return validate();" name="search" style="cursor:pointer" type="submit" value="Search" />
                    </td>
                </tr>
            </table>
        </form>';
            ...
            if ($num == 0) {
              ...
              while ($i < $num) {
                ...
                $id = $row["FIRM_ID"];
                $name = $row["FIRM_NAME"];
                $logo1 = $row["LOGO_NAME1"];
                $logo2 = $row["LOGO_NAME2"];
                $owner = $row["FIRM_OWNER"];
                $cnic = $row["FIRM_OWNER_CNIC"];
                $address = $row["FIRM_ADDRESS"];
                $fix1 = $row["FIXED_LINE1"];
                $fix2 = $row["FIXED_LINE2"];
                $cell1 = $row["MOBILE_NO1"];
                $cell2 = $row["MOBILE_NO2"];
          ...
          ?>
                ...
                <table width="89%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td align="left"><input type="text" name="firm_id" id="firm_id" value="<?php echo $id; ?>" />
                      <input type="hidden" name="old_id" id="old_id" value="<?php echo $id; ?>" />
                    </td>
                    <td align="left">&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="32%" align="left"><select name="plan" id="plan" onchange="show_plan(this.value)">
                        ...
                        <?php
                          ...
                          echo "<option value=''>Error loading plans</option>";
                        }
                        ?>
                      </select>
                    </td>
            ...
            <form name="search_laywer" id="search_laywer" method="post" onsubmit="return validate();">
              <table width="80%" border="0" align="left" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="45%">Search:&nbsp;&nbsp;&nbsp;
                    <input type="text" name="firm_value" id="firm_value">
                  </td>
                  <td width="55%" align="left">Search Type:&nbsp;&nbsp;&nbsp;
                    <select name="type" id="type">
                      <option value="">Select Type</option>
