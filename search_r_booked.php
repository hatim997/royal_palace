            ...
            <table width="719">
                <tr>
                    ...
                    <td width="223"> <select id="type" style="color:#000; font-size:14px; font-weight:500;">
                            ...
                            <option value="id">Booking no.</option>
                            <option value="name">Customer Name</option>
                            <option value="cnic">Customer CNIC</option>
                            <option value="cellno">Customer Cell No</option>

                        </select>


                    </td>
                    <td width="139"><input type="button" value="Search" onclick="search_record_room();" style="background: #FFFFD2; color:#000; height:35px; width:85px; font-size:16px; font-weight:600; border:groove; border-color:#CCC;" /></td>
