...
<head>
  ...
  <SCRIPT LANGUAGE="JavaScript">
    function validate() {
      if (document.notice_board.notice_title.value.length < 1) {
        alert("Please enter Notice Title Field .");
        return false;
      }
      if (document.notice_board.notice_detail.value.length < 1) {
        alert("Please enter Notice Detail Field .");
        return false;
      }
      if (document.notice_board.start_time.value.length < 1) {
        alert("Please enter Start Time Field .");
        return false;
      }
      if (document.notice_board.end_time.value.length < 1) {
  ...
  <div id="templatemo_container">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_middle_column">
        ...
        <h1 class="style1" style="font-size:16px;"><strong>Add Updates</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
        <br>

        <p align="justify" class="em_text"><?php
if (isset($_POST['submit'])) {
    ...
    $date_time = date('Y-m-d H:i:s'); // You can uncomment if not already defined elsewhere
    $time = date('H:i:s'); // You can uncomment if not already defined elsewhere

    $query = "SELECT MAX(NOTICE_ID) AS max_id FROM notice_board_tab";
    ...
    while ($i < $num) {
        ...
        $notice_id = $row["max_id"];
        $i++;
    }
    $notice_id++;

    $query = "INSERT INTO notice_board_tab 
              VALUES('$notice_id','$notice_title','$notice_detail','$start_time','$end_time','$time','E','$created_id','$date_time','$created_id','$date_time')";

    mysqli_query($conn, $query) or die('Insertion Failed: ' . mysqli_error($conn));
?>


        <form method="post" action="" id="notice_board" name="notice_board">
          <table width="300" align="center" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>Notice Detail:</td>
              <td><input type="text" name="notice_detail" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><input type="text" name="start_time" class="tcal" />
                <script language="JavaScript">
                  new tcal({
                    'formname': 'notice_board',
            ...
            <tr>
              ...
              <td> <input type="text" name="end_time" class="tcal" />
                <script language="JavaScript">
                  new tcal({
                    'formname': 'notice_board',
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name="submit" class="button" type="submit" value="Submit" />&nbsp;&nbsp;&nbsp;<input name="reset" type="reset" class="button" value="Reset" /></td>
            </tr>
          </table>
        </form>
      <?php
