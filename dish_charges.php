		...
		<div id="templatemo_content">
			...
			<div id="templatemo_middle_column">
				...
				if (isset($_POST['submit'])) {
					...
					$query = "UPDATE dish_charges_history 
              SET CHARGES_OFF_DATE = '$charges_off_date' 
              WHERE DISH_ID = '$dish' AND DISH_CHARGES_ID = '$charges'";
							...
							<tr>
								...
								<td width="230">
									<select name="food" onchange="show_dish(this.value);">
										<option value="">Select Food</option>
										<?php
										// Make sure $conn is your mysqli connection
										$query = "SELECT * FROM food_type_tab ORDER BY FOOD_TYPE_DETAIL ASC";
										$result = mysqli_query($conn, $query) or die("Failed: " . mysqli_error($conn));
										$num = mysqli_num_rows($result);
										$i = 0;
