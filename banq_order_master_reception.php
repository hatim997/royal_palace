...
if ($userid == '') {
	include('index.php');
	include('index_blank.php');
	include('index_blank1.php');
	include('index_blank2.php');
	include('index_blank.php');
	include('index_blank1.php');
	include('index_blank.php');
	include('index_blank1.php');
	...
	//		<form name="form19" id="form19" method="post" action="index.php">;
	passthru('clear');
}
...
<script language="JavaScript">
	...
	<link rel="stylesheet" href="https://code.jquery.com/ui/1.9.2/themes/dark-hive/jquery-ui.css" />
	<!--https://code.jquery.com/ui/1.9.2/themes/dark-hive/jquery-ui.css-->
  ...
  -->
				...
				<li><a class="MenuBarItemSubmenu" href="#">&nbsp;&nbsp;Dish Management&nbsp;&nbsp;&nbsp;&nbsp;</a>
					<ul>
						...
						<!-- 	<li><a href="edit_dish_master.php">Edit Dish</a></li> -->
						<!--	<li><a href="#">Edit Dish</a></li>  -->
						<!--  <li><a href="view_reqs.php">View Requisitions</a></li> -->
		...
		<form name="form1" id="form1" method="post" action="reception_book2.php">
			<div id="templatemo_content2">
				<h1 align="justify"><span class="style3"><?php echo $today; ?></span></h1>
				<h1 align="justify" class="red" style=" font-size:16px;"><span style="text-align: left"></span>Welcome <BLINK><?php echo $_SESSION['username']; ?></BLINK>
				</h1>
				<div align="justify">
					...
					<table width="800" border="0" cellpadding="0" cellspacing="0" style="">
						<tr>
							<th width="142" valign="top" style="text-align: justify">
					...
					<div id="entry">
						<table width="800" border="0" cellpadding="0" cellspacing="0" style="">
							<tr>
								<th width="179" valign="top" style="text-align: justify">
									<div align="center">Lunch</div>
								</th>
								<td width="621" style="text-align: justify">
									<div align="left">
										<?php
										...
										while ($row = mysqli_fetch_assoc($result1)) {
											...
											if ($num2 > 0 && $row['BANQ_ID'] == $row2['BANQ_ID']) {
												if ($row2['BOOKING_STATUS'] == 'B' && $row2['TIME_FROM'] == '12:00:00' && $row2['TIME_TO'] == '17:00:00') {
													$f_id = $row2['ORDER_NO'];
													$query3 = "SELECT count(*) as count FROM banq_order_master WHERE ORDER_NO = '$f_id'";
													...
													if ($cc == "1") {
										?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style="font-weight:900; border-width: medium; background-color:#F00;" class="box1" onclick="buttonA_clickHandler();" />
													<?php
													} else if ($cc == "2") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style="font-weight:900; border-width: medium; background-color:#66F;" class="box1" onclick="buttonA_clickHandler();" />
													<?php
													} else if ($cc == "3") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style="font-weight:900; border-width: medium; background-color:#363;" class="box1" onclick="buttonA_clickHandler();" />
													<?php
													} else if ($cc == "4") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style="font-weight:900; border-width: medium; background-color:#09F;" class="box1" onclick="buttonA_clickHandler();" />
													<?php
													} else if ($cc >= "5") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style="font-weight:900; border-width: medium; background-color:#FF0;" class="box1" onclick="buttonA_clickHandler();" />
													<?php
													}
												} else if ($row2['BOOKING_STATUS'] == 'T' && $row2['TIME_FROM'] == '12:00:00' && $row2['TIME_TO'] == '17:00:00') {
													?>
													<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style="font-weight:900; border-width: medium; background-color:#F9C;" class="box1" onclick="buttonA_clickHandler();" />
												<?php
												} else {
												?>
													<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style="font-weight:900; border-width: medium;" class="box1" onclick="buttonA_clickHandler();" />
												<?php
												}
											} else {
												?>
										...
										while ($row = mysqli_fetch_assoc($result1)) {
											...
											if ($num2 > 0 && $row['BANQ_ID'] == $row2['BANQ_ID']) {
												if ($row2['BOOKING_STATUS'] == 'B' && $row2['TIME_FROM'] == '18:00:00' && $row2['TIME_TO'] == '23:00:00') {
													...
													if ($cc == "1") {
										?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style=" font-weight:900; border-width: medium; background-color:#F00;" class="box1" onclick="buttonB_clickHandler();" />
													<?php
													} else if ($cc == "2") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style=" font-weight:900; border-width: medium; background-color:#66F;" class="box1" onclick="buttonB_clickHandler();" />
													<?php
													} else if ($cc == "3") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style=" font-weight:900; border-width: medium; background-color:#363;" class="box1" onclick="buttonB_clickHandler();" />
													<?php
													} else if ($cc == "4") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style=" font-weight:900; border-width: medium; background-color:#09F;" class="box1" onclick="buttonB_clickHandler();" />
													<?php
													} else if ($cc >= "5") {
													?>
														<input name="<?php echo $id; ?>" id="button1" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style=" font-weight:900; border-width: medium; background-color:#FF0;" class="box1" onclick="buttonB_clickHandler();" />
													<?php
													}
												} else if ($row2['BOOKING_STATUS'] == 'T' && $row2['TIME_FROM'] == '18:00:00' && $row2['TIME_TO'] == '23:00:00') {
													?>
													<input name="<?php echo $row['BANQ_ID']; ?>" id="button" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style=" font-weight:900; border-width: medium; background-color:#F9C;" class="box1" onclick="buttonB_clickHandler();" />
												<?php
												} else {
												?>
													<input name="<?php echo $row['BANQ_ID']; ?>" id="button" type="submit" value="<?php echo $row['BANQ_NAME']; ?>" style=" font-weight:900; border-width: medium;" class="box1" onclick="buttonB_clickHandler();" />
												<?php
												}
											} else {
												?>
