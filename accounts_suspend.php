  ...
  <div id="templatemo_container">
    ...
    <div id="templatemo_content">
        ...
        <div id="leftcolumn_box01">
          ...
          <div class="leftcolumn_box01_bottom">
            <div id="menu2" class="form_row">
              <ul>
                <li><a href="expense_type.php">Add Expense Type</a></li>
                <li><a href="expense_item.php">Add Expense Item</a></li>
                <li><a href="director.php">Add Director</a></li>
                <li><a href="expense_closing.php">Expense Closing</a></li>
                <li><a href="expense_transaction.php">Expense Transaction</a></li>
      ...
      <div id="templatemo_middle_column">
        <h1 class="style1" style=" font-size:16px;">Welcome to Web Saucer</h1>
        <h1 class="style1" style=" font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1>
      </div>
