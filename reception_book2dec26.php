...
function myFunction()
{
var txt = document.form.country.value;
alert(txt);
var xmlhttp_1;
if (window.XMLHttpRequest)
  {// code for IE7+, Firefox, Chrome, Opera, Safari
...
xmlhttp_1.onreadystatechange=function()
  ...
  if (xmlhttp_1.readyState==4 && xmlhttp_1.status==200)
    {
    //document.getElementById("demo").innerHTML=xmlhttp_1.responseText;
	alert(xmlhttp_1.responseText);
    }
  }
xmlhttp_1.open("GET","add_manual_dish.php?dish1="+txt,true);
xmlhttp_1.send();
}
</script>
