...
<input name="search" type="button" value="Search"  style="background: #F30; color:#000; height:35px; width:85px; font-size:16px; font-weight:600; border:groove; border-color:#CCC;" onclick="search_banq();"/>
<!--
<input name="thermal_print" type="button" value="Thermal Print"  onclick="submitMe(this);"  style="background: #F30; color:#000; height:35px; width:auto; font-size:16px; font-weight:600; border:groove; border-color:#CCC;"/>-->
