...
<div id="templatemo_content">
 ...
 <input type="button" value="Print Dishes" onclick="printSelection(document.getElementById('printing'));return false" />
...
<?php } ?>
  ...
  <td><h1 style=" font-size:18px; color:#F00;"> Net Payable <input name="net" type="text" size="10" readonly="readonly" id="net" style="font-size:22px; font-weight:900; color:#F00;"
   value="<?php
    if ($ans5['total_received']!=0){
   echo $ans5['DIFFERENCE_AMOUNT'];
   }
   else
   {
