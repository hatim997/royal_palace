...
<head>
	...
	<SCRIPT LANGUAGE="JavaScript">
		function validate() {
			if (document.case.case_name.value.length < 1) {
				alert("Please enter Case Name  Field .");
				return false;
			}
			return true;
		}
	...
	<script type="text/javascript">
		function ajax_force_logout() {
			var user_id = encodeURIComponent(document.getElementById("user").value);
			...
			xmlhttp.open("POST", "ajax_force_logout.php", true);
...
<body>
	<div id="templatemo_container">
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_middle_column">
				...
				<h1 class="style1" style=" font-size:16px;">Force Logout User&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1>
	...
	ORDER BY user_tab.USER_NAME ASC";
					...
					?>
						<h2 class="style2">Currently no User Logged In</h2>
					<?php
					} else {
						...
						<form>
							...
							<select id="user">
								...
								?>
									...
									<option value="<?php echo $user_id; ?>"><?php echo $name . " ( " . $user_id . " )"; ?></option>
								<?php
