...
<body onclick="clicked=true;" onbeforeunload="CheckBrowser()">
  <div id="templatemo_container">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_middle_column">
        ...
        if (isset($_POST['submit'])) {
          //$time = date('H:i:s');
          $date_time = date('Y-m-d H:i:s'); // Added since it was commented
          ...
          // Get next DISH_CHARGES_ID
          $query = "SELECT MAX(DISH_CHARGES_ID) AS max_id FROM dish_charges_history";
          $result = mysqli_query($conn, $query) or die("Query Failed: " . mysqli_error($conn));
          $row = mysqli_fetch_assoc($result);
          $dish_charges_id = $row['max_id'] + 1;

          // Insert into dish_master_tab
          $query = "INSERT INTO dish_master_tab 
    VALUES('$rest_id','$kit_id','$food','$dish_id','$dish','$dish_detail','$serving','$cook_time','$dish_charges_id',
    ...
    VALUES('$rest_id','$dish_id','$dish_charges_id','$charges','$charges_on_date','$charges_off_date',
    '$created_id','$date_time','$created_id','$date_time')";
            ...
            <table width="350" align="center" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><select id="food" name="food">
                    <option value="">Select Food</option>
                    <?php
                    // Ensure $conn is your valid mysqli connection
                    $query = "SELECT * FROM food_type_tab WHERE REST_ID = '$rest_id'";
                    $result = mysqli_query($conn, $query) or die("Query Failed: " . mysqli_error($conn));
