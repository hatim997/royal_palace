...
<?php
	...
	?>
    <form name="form1" method="post" action="gym_mem_type.php">
    <table width="1005" border="0" >
	<?php
if($type == "id")
	{
		
$sql="SELECT * FROM gym_membership_period_tab WHERE MEMBER_PERIOD_ID ='$value'";
...
if($type == "name")
	{
$sql="SELECT * FROM gym_membership_period_tab WHERE MEMBER_PERIOD_TITLE ='$value'";
$result = mysql_query($sql);
$count=mysql_num_rows($result);
if($count != "")
		 {
