...
if($ins2 != "")
	{
$query13="INSERT INTO payment_serial
(`CR_NO`,`ORDER_ID`, `INSTALMENT_NO`, `INSTALMENT_AMOUNT`, `CREATED_ID`, `CREATED_ON`) 
...
if($ins3 != "")
	{
$query14="INSERT INTO payment_serial
(`CR_NO`,`ORDER_ID`, `INSTALMENT_NO`, `INSTALMENT_AMOUNT`, `CREATED_ID`, `CREATED_ON`) 
...
WHERE ORDER_NO = '$id' AND FUNCTION_DATE = '$function_date' AND BANQ_ID = '$banq_id'";
...
if($ins2 != "")
	{
$query20="SELECT CR_NO FROM payment_serial WHERE ORDER_ID = '$id' AND INSTALMENT_NO = '2'";
		$result20=mysql_query($query20);
		while($h20=mysql_fetch_array($result20))
		{
			if($adv_cr2==$h20['CR_NO'])
				{	
$query25="UPDATE payment_serial SET
...
$query21="SELECT CR_NO FROM payment_serial WHERE ORDER_ID = '$id' AND INSTALMENT_NO = '3'";
