...
<?php
	...
	<tr>
	  ...
	  <a class="style1" style="font-size:16px;" href="http://www.wiitechmill.com/dev/royalpalace/accounts/receipt.php?gid='.$gid.'&on='.$orderno.'&dis='.$total_discount.'">Print Bill</a></td>
	</tr>
	<tr height="3%">
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
