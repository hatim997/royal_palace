...
<?php
			...
			while($i < $num)
			{
				...
				if($status == "O")
			  	{
					...
					<td width="100" align="left">&nbsp;'.$qty*$charges.'</td>
				...
				else if($status == "C")
			  	{
				  	echo '<tr>
							...
							<td style="color:#0000FF" width="100" align="left">&nbsp;'.$qty*$charges.'</td>
				...
				else if($status == "R")
				{
					echo '<tr>
							...
							<td style="color:#800080" width="100" align="left">&nbsp;'.$qty*$charges.'</td>
				...
				else
				{
					echo '<tr>
							...
							<td style="color:#FF0000" width="100" align="left">&nbsp;'.$qty*$charges.'</td>
  ...
  <tr>
    <td width="120" align="left">Service Charges:</td>
    <td width="380" align="left"><input type="text" id="service" name="service" value="'.$service_charges.'" readonly="readonly" />&nbsp;&nbsp;'.$service_value.'% of Gross Amount</td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td width="120" align="left">Tax:</td>
    <td width="380" align="left"><input type="text" id="tax" name="tax" value="'.$total_tax.'" readonly="readonly" />&nbsp;&nbsp;'.$tax_value.'% of GST</td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td width="380" align="left"><select name="discount" id="discount" onchange="order_form_chg(this.value);">
  ...
  <option value="100">Complimentary</option>
</select></td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
  ...
  <!--<tr>
    ...
    <td width="380" align="left"><input type="text" id="received" name="received" value="'.$rec_amount.'" readonly="readonly" /></td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr align="center">                    
    ...
    <td align="left" width="380" valign="bottom"><input type="button" onclick="payment_reception(this.form)" class="button" align="left" style="cursor:pointer"name="Submit" value="Submit" /><input type="reset" class="button" style="cursor:pointer" name="reset" value="Reset">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
  </table>
