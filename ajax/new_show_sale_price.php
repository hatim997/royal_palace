...
<?php
	...
	$value = $_POST['value'];
	$query1 = "SELECT dish_master_tab.DISH_ID, dish_master_tab.COOKING_TIME, dish_charges_history.DISH_ID, 
	...
	while($i < $num1)
	{
		$cooking_time = mysql_result($result1,$i, "dish_master_tab.COOKING_TIME" );
