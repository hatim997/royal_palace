...
<?php
	...
	(GUEST_ID, GUEST_NAME, DATE_OF_BIRTH, GUEST_MOBILE_NO, GUEST_EMAIL, GUEST_CITY, PROFESSION_ID, CREATED_ID, CREATED_ON, EDITED_ID, EDITED_ON) VALUES('$guest_id','$name','$dob','$cell','$email','$city','$pro_type','$created_id','$date_time','$created_id','$date_time')";
