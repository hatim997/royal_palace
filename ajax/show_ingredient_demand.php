	...
	*/
	echo '<div class="threadlisthead table" style="background:url(images/dock-bg.png); width: 650px; margin-left:40px;">
				...
				<span class="threadinfo">
					...
					<span class="threadstats td" style=" margin-left:170px;">Qty Inhand</span>
                    <span class="threadlastpost td" style=" margin-left:12px; width: 100px;">Demand</span>
	...
	<div class="rating5 nonsticky" style="width:650px;">
		...
		<dd >
	<strong><div style="margin-top:10px;"><span style="margin-left:30px; padding-top: 5px;"><input type="text" style="background:#43C6DB;" name="'.$d_id.'" id="demand'.$i.'" size="5" />
	</span></div></strong>
 </dd>	
