...
<?php
	...
	$query =  "UPDATE voucher_master SET RECORD_FLAG = 'S' WHERE VOUCHER_ID = '$voucher_id' AND CREATED_ON LIKE '$current_date%'";
	mysql_query($query) or die("Failed 1: ".mysql_error());
	
	$query =  "UPDATE voucher_transaction SET RECORD_FLAG = 'S' WHERE VOUCHER_ID = '$voucher_id' AND VOUCHER_DATE = '$current_date'";
	mysql_query($query) or die("Failed 1: ".mysql_error());
