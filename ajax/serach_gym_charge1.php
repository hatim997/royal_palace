...
<?php
	...
	?>
    <form name="form1" method="post" action="gym_charges.php">
    <table width="1005" border="0" >
	<?php
if($type == "id")
	{
		
$sql="SELECT CHARGES_ID, CHARGES_TYPE_ID, GYM_CHARGES,
CHARGES_ON_DATE, CHARGES_OFF_DATE FROM gym_charges_plan WHERE CHARGES_ID ='$value'";
	...
	while($row = mysql_fetch_array($result))
  	{  ?>
			...
			<?php
			 ...
			 $sql1="SELECT CHARGES_TITLE FROM gym_charges_type_tab WHERE CHARGES_TYPE_ID = $b_id";
...
if($type == "name")
	{
$sql="SELECT CHARGES_ID, CHARGES_TYPE_ID, GYM_CHARGES,
CHARGES_ON_DATE, CHARGES_OFF_DATE FROM gym_charges_plan WHERE CHARGES_TYPE_ID ='$value'";
$result = mysql_query($sql);
$count=mysql_num_rows($result);
if($count != "")
		 {
