...
<?php
  ...
  <tr>
    ...
    <td width="380" align="left"><input type="text" id="discount" name="discount" value="'.$discount.'" readonly="readonly" />&nbsp;&nbsp;'.number_format(($discount/$gross)*100).'% of Gross Amount</td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
