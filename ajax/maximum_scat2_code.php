...
<?php
	...
	$query1 = "SELECT MAX(SCAT2_ACCT_CODE) FROM scat2_acct_tab WHERE MAIN_ACCT_CODE = '$main' 
				AND CTRL_ACCT_CODE = '$ctrl' AND SCAT1_ACCT_CODE = '$scat'";
	$result1 = mysql_query($query1)or die("Failed :".mysql_error());
	$num1 = mysql_numrows($result1);
	$i=0;
	while($i < $num1)
	{
		$trans_id = mysql_result($result1,$i, "MAX(SCAT2_ACCT_CODE)" );
		$i++;
	}
	//$trans_id++;
