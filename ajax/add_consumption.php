...
for ($a = 0; $a < $no; $a++) {
	...
	$query = "INSERT INTO restaurant_consumption
	(REST_ID, INGREDIENT_ID, CONSUMPTION_QTY, CONSUMPTION_DATE, CREATED_ID, CREATED_ON, EDITED_ID, EDITED_ON) 
	VALUES('$restid','$dish','$qty','$current_date','$created_id','$date_time','$created_id','$date_time')";
