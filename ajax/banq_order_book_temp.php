...
WHERE ORDER_NO = '$id' AND BANQ_ID = '$banq_id'";
//BANQ_ID = '$mbanq_old_id'";
...
//$query65="UPDATE banq_order_master SET BANQ_ID = '$banq_id'  WHERE ORDER_NO = '$id' AND BANQ_ID = '$mbanq_old_id'";
//mysql_query($query65) or die('Updation Failed:'.mysql_error());
...
hall_adv = '$hall_rate', adv_total = '$adv_total', total_received = '$received_amount', EDITED_ID = '$edited_id', EDITED_ON  ='$edited_on'
 WHERE ORDER_NO = '$id' AND FUNCTION_DATE = '$function_date' AND AND BANQ_ID = '$hall'";
  // BANQ_ID = '$mbanq_old_id'";
...
//+++++++++++++   Record should not be deleted If hall is shifted, so it is marked  January 26, 2015    +++++++++++++++    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
