...
$banq_hidden = $_POST['banq_hidden'];// hidden value for banquets
//$add_hall1_hidden = $_POST['add_hall1_hidden'];//hidden check box for additional halls
...
$edited_on = date("Y-m-d", $tdate);
	...
	$function_date = $_POST['date11'];
	$shift_func = $_POST['shift_func'];
	//$change_function = '2013-10-15';//shift function to this date
	//echo '<div style="width:1000px">'.$change_function.'</div>';
	
	if($shift_func =='')
	{
	$shift_func = $function_date;
	//echo $change_function;
	}
	//exit;
...
if($misc_charge!="")
{
	...
	//$change_function = $_POST['change_function'];
	$query5="UPDATE banq_order_master SET
ORDER_NO = '$id', BANQ_ID = '$banq_id', FUNCTION_TYPE_ID = '$function_type_id', FUNCTION_DATE = '$shift_func' , GUEST_NAME = '$guest_name', 
GUEST_ADDRESS = '$guest_address', CONTACT_PERSON = '$contact_person' , CONTACT_NO = '$contact_no', CONTACT_NO1 = '$contact_no1',
CONTACT_NO2 = '$contact_no2',BOOKING_STATUS = '$b_status' , TIME_FROM = '$slot_from', TIME_TO = '$slot_to' , TOTAL_CHARGES_BANQ = '$b_rate_total',
...
total_received = '$received_amount', EDITED_ID = '$edited_id', EDITED_ON  ='$edited_on'
WHERE ORDER_NO = '$id' AND FUNCTION_DATE = '$function_date' AND BANQ_ID = '$banq_hidden'";

mysql_query($query5) or die('Updation Failed:'.mysql_error());
//update the theme
$query77="UPDATE banq_color_scheme_history SET FUNCTION_ID = '$id', FUNCTION_DATE = '$shift_func', FUNCTION_TIME = '$func_time',
...
if(!in_array($value, $_POST['menu_order1'],true))
{
	...
	$query7="INSERT INTO banq_order_history_tab(`ORDER_NO`,`DEMAND_NO`, `DISH_ID`, `DISH_CHARGES_ID`,`EDITED_ID`, `EDITED_ON`) VALUES ('$id','', '$dish_item_id', '$dish_item_charges', '$edited_id' , '$edited_on')";
				...
				$d_num=$ans22+1;
					...
					while($ans11=mysql_fetch_array($r11))
					{
						...
						while($ans33=mysql_fetch_array($r33))
						{
							...
							$req_qty = $ans33['REQUIRED_QUANTITY'];
							$total_demand = $guest_guranted * $req_qty;
							$query44="INSERT INTO restaurant_demand(`REST_ID`, `DISPLAY_NAME`, `INGREDIENT_ID`, `DEMAND_NO`, `DEMAND_QTY`, `DEMAND_DATE`,
							 `UNIT_ID`, `CREATED_ID`, `CREATED_ON`, `READ_FLAG`)
							 VALUES
							 ('$restid','$display_name','$ind_code','$d_num','$total_demand','$function_date','$unit_id','$created_id','$created_on','0')";
							$result44=mysql_query($query44) or die('Demand Insertion Failed'.mysql_error());
						}	
					}	
					$query55="UPDATE banq_order_history_tab SET DEMAND_NO = '$d_num' WHERE ORDER_NO = '$id'";
...
GUEST_ADDRESS = '$guest_address', CONTACT_PERSON = '$contact_person' , CONTACT_NO = '$contact_no',CONTACT_NO1 = '$contact_no1', CONTACT_NO2 = '$contact_no2',FUNCTION_DATE = '$shift_func', BOOKING_STATUS = '$b_status' , TIME_FROM = '$slot_from',
TIME_TO = '$slot_to' , TOTAL_CHARGES_BANQ = '$b_rate_total', PAYMENT_MODE_BANQ = '$p_mode', CHEQUE_NO_BANQ = '$chequeno', BANK_BANQ = '$bank', CREDIT_CARD_NO_BANQ = '$card_no', DIFFERENCE_AMOUNT = '$net', DISCOUNT_DETAIL = '$discount', BOOKING_DATE = '$booking_date', guest_expected = '$guest_expected', 
guest_guranteed = '$guest_guranted', function_incharge = '$function_incharge', CNIC = '$cnic', taste = '$taste', 
SPL_notes = '$spl_notes', notes = '$extra_notes', add_notes = '$add_notes', Stage_no = '$stage_no', Sound = '$sound', Video = '$video',
Misc = '$misc', b_rate = '$b_rate', b_rate_total = '$b_rate_total', Drink_no = '$drinks', Drink_rate = '$drinks_rate', 
Drink_rate_total = '$drinks_total', tea_no = '$tea' , tea_rate = '$tea_rate', tea_rate_total= '$tea_total', water_no = '$water' ,
...
VALUES ('$id', '$hall', '$function_type_id', '$guest_name', '$guest_address', 
'$contact_person', '$contact_no', '$contact_no1', '$contact_no2','$shift_func', '$b_status', '$slot_from', 
'$slot_to', '$b_rate_total', '$p_mode', '$chequeno', '$bank', '$card_no',
'$net', '$discount', '$booking_date', '$guest_expected', '$guest_guranted', '$function_incharge', '$cnic', '$taste',
  '$spl_notes', '$extra_notes','$add_notes', '$stage_no', '$sound', '$video', '$misc', '$b_rate', '$b_rate_total', '$drinks', '$drinks_rate', 
'$drinks_total', '$tea', '$tea_rate', '$tea_total', '$water', '$water_rate', '$water_total',
...
GUEST_ADDRESS = '$guest_address', CONTACT_PERSON = '$contact_person' , CONTACT_NO = '$contact_no', CONTACT_NO1 = '$contact_no1', CONTACT_NO2 = '$contact_no2', FUNCTION_DATE = '$shift_func',
