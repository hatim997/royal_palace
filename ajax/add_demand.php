...
echo '<a class="style1" style="font-size:16px;" href="http://www.wiitechmill.com/dev/royalpalace/accounts/demand_print.php?dn=' . $demand_no . '" target="_blank">Print Demand</a>';
