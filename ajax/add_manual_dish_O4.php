		...
		while($row = mysql_fetch_array($result))
		  {	  
			...
			if($max_dish_id!=1) 
			{
				...
				$qry="INSERT INTO dish_master_tab(`REST_ID`, `KITCHEN_ID`, `FOOD_TYPE_ID`,`DISH_ID`, `DISH_NAME`) VALUES ('1', '1', '20', '$max_dish_id', '$_REQUEST[country]')";
				
				$query_add_dish = mysql_query($qry);
				if(!$query_add_dish)
				{
					 return false;
				}
