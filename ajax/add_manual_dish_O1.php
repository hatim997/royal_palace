...
if(strlen($queryString) >0) 
	...
	$query_add_dish = $db->query("INSERT INTO dish_master_tab('REST_ID', 'KITCHEN_ID', 'FOOD_TYPE_ID', 'DISH_ID', 'DISH_NAME', 'CREATED_ID', 'CREATED_ON') VALUES ('1', '1', '20', '$max_dish_id', '$queryString', '$created_id' , '$created_on')");
