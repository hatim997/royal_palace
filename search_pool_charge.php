    ...
    <div id="div">
        <form>
            ...
            <table width="719">
                <tr>
                    <th width="80">Type:</th>
                    <td width="227"> <select id="type" style="color:#000; font-size:14px; font-weight:500;" onchange="search_cplan_value();">
                    ...
                    <td width="135"><input type="button" value="Search" onclick="search_pool_charge_plan();" style="background: #FFFFD2; color:#000; height:35px; width:85px; font-size:16px; font-weight:600; border:groove; border-color:#CCC;" /></td>
