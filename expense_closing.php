		...
		<div id="templatemo_content">
			...
			<div id="templatemo_middle_column">
				...
				if (isset($_POST['submit'])) {
					...
					$query = "SELECT max(EXPENSE_CLOSING_ID) AS max_id FROM expense_closing_history";
					$result = mysqli_query($conn, $query);
					if (!$result) {
						die("Query failed: " . mysqli_error($conn));
					}
					$row = mysqli_fetch_assoc($result);
					$expense_clo_id = $row['max_id'] + 1;

					$query = "INSERT INTO expense_closing_history 
		VALUES ('$expense_clo_id', '$expense_clo_dt', '$expense_clo_detail', '$created_id', '$date_time', '$created_id', '$date_time')";
					...
					$update = "UPDATE expense_closing_tab 
		SET LAST_EXPENSE_CLOSING_DATE = '$expense_clo_dt', 
		    EDITED_ID = '$user', 
		    EDITED_ON = '$date_time'";
