...
libs/jquery/1.3.0/jquery.min.js"></script>
	...
	<script type="text/javascript">
		function dish_status(orderno, status) {
			...
			xmlhttp.open("POST", "ajax/dish_status_rec.php", true);
			xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xmlhttp.send("orderno=" + orderno + "&status=" + status);
		}
	</script>
	<script type="text/javascript">
		var clicked = false;
                ...
                <tr>
					...
					<td width="90" align="center"><strong>Status</strong></td>
						...
						while ($i < $num) {
							...
							$service  = $row["TOTAL_SERV_CHARGES"];
							$switch   = $row["SWITCH"];
							$tax      = $row["TAX_VALUE"];
