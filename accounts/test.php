	...
	<div id="templatemo_content">
        ...
        <!-- start of middle column -->
   	  ...
   	  <div id="templatemo_middle_column">
          ...
          <p>&nbsp;</p><div class="rating5 nonsticky">
          <div id="threadinfo" style="width: 400px; position:fixed; display: table-row; height:auto;">
          <br><br><br><br>
          </div><div id="abc" style="width: 150px; position:fixed; margin-left: 402px; margin-top: -36px; height:auto;">
          <br><br><br><br>
          </div><div id="def" style="width: 150px; position:fixed; margin-left: 552px; margin-top: -36px; height:auto;">
          <br><br><br><br>
          </div><div id="jhi" style="width: 150px; position: static; margin-left: 703px; margin-top: -36px; height:auto;">
          <br><br><br><br>
          </div></div><br><br>	<!-- end of master division -->
