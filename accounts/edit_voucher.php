...
if(isset($_GET['y']))
{
	...
	$simple = "yes";
	$link = '<a href="view_ledger.php?type='.$type.'&code='.$value.'&todate='.$to_date1.'&option=TRN_DATE&y=n" title="Go to Ledger">Back</a>';
}
else
{
	$value = $_GET['code'];
	...
	$option = $_GET['sort'];
	$simple = "no";
	$link1 = '<a href="view_ledger.php?type='.$type.'&code='.$value.'&todate='.$to_date.'&option=TRN_DATE&sort='.$option.'" title="Go to Ledger">';
}
?>
...
<!-- start of content -->
  ...
  <div id="templatemo_content">
        ...
        <!-- start of middle column -->
    	  ...
    	  <h1 class="style1" style=" font-size:16px;">Voucher Editing Form&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
