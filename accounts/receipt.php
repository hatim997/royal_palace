      ...
      <?php
		...
		?>
              ...
              <table width="349" border="0" cellpadding="0" cellspacing="5" align="left">
                <tr>
                   <td width="111" align="left"><strong>Gross Charges:</strong></td><td width="70" align="left"><?php echo $gross; ?></td>
                </tr>
                <tr>
                   
                   <td width="111" align="left"><strong>Service Charges:</strong></td><td width="70" align="left"><?php echo $service_charges; ?></td><td width="148"><?php echo $service_value; ?>%</td>
                </tr>
                <tr>
