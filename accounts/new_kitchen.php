...
<h1 class="style1" style="font-size:16px;">New Kitchen &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
			...
			if(isset($_POST['submit']))
			{
				...
				$query = "SELECT max(KITCHEN_ID) FROM kitchen_master_tab";
				...
				while($i < $num1)
				{
					$id = mysql_result($result,$i, "max(KITCHEN_ID)" );
					$i++;
				}
				$id++;
						
				$query = "INSERT INTO kitchen_master_tab 
				VALUES('$rest_id','$id','$kitchen','$created_id','$date_time','$created_id','$date_time')";
					
				mysql_query($query) or die('Insertion Failed:'.mysql_error());
				echo '<h4 class="style9">Kitchen Successfully Defined</h4><br><br>';
				?>
  ...
  <tr>
    <td>Kitchen Name:</td>
    <td><input type="text" name="kitchen" id="kitchen" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
