...
<?php
    ...
    $query2 = "UPDATE order_history_tab SET DISH_QTY='$new_req_quantity' WHERE ORDER_NO = '$order_no' && DISH_ID='$dish_id'";
    ...
    <td>
       ...
       <?php
			...
			while($i < $num1)
			{
				...
				echo "<td align='left' style='background:#FFF; font-size:16px; color:#2083AC;' >";  
				echo '<table border="0" >';
				echo '<tr>';
