...
<?php
	...
	for($a = 0; $a < $no; $a++)
	{
		...
		mysql_query($query) or die('Restaurant Inventory Update Failed:'.mysql_error());
	...
	echo '<a class="style1" style="font-size:16px;" href="http://www.wiitechmill.com/royalpalace/accounts/invoice_print.php?dn='.$demandno.'&in='.$invoice_no.'" target="_blank">Print Invoice</a>';
	$blank = 0;
