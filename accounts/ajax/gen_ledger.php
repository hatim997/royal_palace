...
<?php
	$query1 = "SELECT * FROM voucher_transaction WHERE TRN_DATE < '$from_date' AND ACCOUNT_CODE = '$value' ORDER BY TRN_DATE DESC";
	...
	$query1 = "SELECT * FROM voucher_transaction WHERE TRN_DATE >= '$from_date' 
				AND TRN_DATE <= '$to_date'  AND ACCOUNT_CODE = '$value' ORDER BY TRN_DATE ASC";
	$result1 = mysql_query($query1)or die("Failed :".mysql_error());
	$num1 = mysql_numrows($result1);
	if($num1 == 0)
	{
	...
	while($i < $num1)
	{
		...
		if($flag == "P")
		{
			...
			echo '<tr style="color:#000; background-color:#BAECBA;">
					  ...
					  <td width="124" align="center"><strong>'.$trn_date.'</strong></td>
		...
		else
		{
			...
			echo '<tr style=" font-style:bold; color:#000; background-color:#F9D8D8;">
					  ...
					  echo '<td width="74" align="center"><strong>'.$display.'</strong></td>
							<td width="82" align="right"><strong>'.$debit.'</strong></td>
							<td width="83" align="right"><strong>'.$credit.'</strong></td>
							<td width="80" align="right"><strong>'.$balance.'</strong></td>';
			echo '</tr>';
		}
		$i++;
...
<tr>
    ...
    <td width="216" align="left"><?php echo $brought_forward; ?></td>
...
<tr>
    ...
    <td width="216" align="left"><?php echo $total_posted; ?></td>
...
<tr>
    ...
    <td width="216" align="left"><?php echo $total_unposted; ?></td>
...
<tr>
    ...
    <td width="216" align="left"><?php echo ($brought_forward + $total_posted + $total_unposted); ?></td>
