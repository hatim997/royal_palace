...
<?php
	...
	echo '<a class="style1" style="font-size:16px;" href="http://www.wiitechmill.com/royalpalace/accounts/store_demand_print.php?dn='.$demand_no.'" target="_blank">Print Demand</a>';
	/*
