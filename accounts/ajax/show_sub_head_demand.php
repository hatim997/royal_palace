...
<?php
	...
	echo '<table width="450" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="140">Select Sub Head:</td>
    <td width="246"><select id="sub_head" name="sub_head" onchange="show_ingredient(this.value)">
