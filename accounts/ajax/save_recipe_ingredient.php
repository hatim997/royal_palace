...
<?php
	...
	//echo 'dish id is '.$dishid.' and ing id is '.$ing_name;
...
WHERE store_master_tab.INGREDIENT_ID = '$ing_name'";
	...
	$query2 = "UPDATE recipe_tab SET REQUIRED_QUANTITY = '$quantity', COST_PRICE = '$cost_price' 
	WHERE DISH_ID = '$dishid' && INGREDIENT_CODE = '$ing_name'";
