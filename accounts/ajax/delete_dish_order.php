...
<?php
	...
	$query2 = "Delete FROM order_history_tab WHERE DISH_ID = '$dish_id' && 	ORDER_NO = '$order_no' ";
...
<div id="master" align="center">
  ...
  <thead style="background:#2083AC; font-size:14px; font-style:italic; color:#FFF;">
    <td align="center" width="475"><b>Tables</b></td>
    <td align="center"  width="475"><b>Dishes</b></td>
  </thead>
  <tr>
    <td>
