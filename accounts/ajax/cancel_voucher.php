...
<?php
	...
	$query = "DELETE from voucher_transaction where VOUCHER_ID = '$voucher_id' AND VOUCHER_DATE = '$current_date'";
	mysql_query($query) or die("Delete Failed: ".mysql_error());
	
	$query =  "UPDATE voucher_master SET RECORD_FLAG = 'D' WHERE VOUCHER_ID = '$voucher_id' AND CREATED_ON LIKE '$current_date%'";
