...
$orderno = $_POST['orderno'];
  ...
  <tr>
    ...
    <td width="380" align="left"><input type="text" id="service" name="service" value="0" readonly="readonly" />&nbsp;&nbsp;'.$service_value.'% of Gross Amount</td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td width="380" align="left"><select>
...
&nbsp;&nbsp;'.number_format(($discount/$gross)*100).'% of Gross Amount</td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  echo '<tr>
    ...
    <td width="380" align="left"><input type="text" id="tax" name="tax" value="0" readonly="readonly" />&nbsp;&nbsp;'.$tax_value.'% of GST</td>
  </tr>
  <tr height="3%">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
