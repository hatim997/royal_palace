...
function validate() {
if (document.profession.profession.value.length < 1) {
...
<h1 class="style1" style="font-size:16px;">New Profession Type &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
            
            <?php
			if(isset($_POST['submit']))
			{
				
				$query = "SELECT max(PROFESSION_ID) FROM profession_tab";
				...
				while($i < $num1)
				{
					$profession_id = mysql_result($result,$i, "max(PROFESSION_ID)" );
					$i++;
				}
				$profession_id++;
				...
				$query = "INSERT INTO profession_tab 
				VALUES('$profession_id ','$profession','$created_id','$date_time','$created_id','$date_time')";
					
				mysql_query($query) or die('Insertion Failed:'.mysql_error());
				echo '<h4 class="style9">Profession Successfully Defined</h4><br><br>';
				?>
            
            
            <form name="profession" method="post" action="" id="profession" onsubmit="return validate();">
