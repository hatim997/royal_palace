...
<script type="text/javascript">
    function payment_mode(value)
    {
		...
		xmlhttp.open("POST","ajax/payment_mode1.php",true);
		xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xmlhttp.send("value="+value);
	}
</script>
...
function payment_reception(form)
{
	...
	var p_mode = encodeURIComponent(document.getElementById("pay_mode").value);
	var diff = encodeURIComponent(document.getElementById("diff").value);
	//var p_status = encodeURIComponent(document.getElementById("p_status").value);
	if(discount == "")
	{
		alert("Discount field must be selected");
		return;
	}
	...
	else
	{
		...
		var discount_details = encodeURIComponent(document.getElementById("discount_details").value);
	}
	if(p_mode == "C" || p_mode == "N")
	{
		var chequeno = "";
		var cardno = "";
		var bank = "";
	...
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	xmlhttp.send("orderno="+orderno+"&gross="+gross+"&discount="+discount+"&service="+service+"&taxid="+taxid+"&rec_amount="+rec_amount+"&p_mode="+p_mode+"&chequeno="+chequeno+"&cardno="+cardno+"&head="+head+"&discount_details="+discount_details+"&bank="+bank+"&diff="+diff);
}
</script>

<script type="text/javascript">
function search_demand(guest)
{
	//alert(" Order no is "+orderno);
	...
	if (type == "")
	{
		...
		alert("Please select correct search type");
		//document.getElementById("results").style.border="0px";
		return;
	}
	if (guest.length==0)
	...
	xmlhttp.onreadystatechange=function()
	  ...
	  if (xmlhttp.readyState==4 && xmlhttp.status==200)
		{
			document.getElementById("demand").innerHTML=xmlhttp.responseText;
			//document.getElementById("results").style.border="1px solid #A5ACB2";
		}
	  }
	xmlhttp.open("POST","ajax/search_demand.php",true);
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	xmlhttp.send("guest="+guest+"&type="+type);
}
</script>

<script type="text/javascript">
    function order_form_chg(value)
    {
		//var p_mode = encodeURIComponent(document.getElementById("pay_mode").value);
		//alert(value);
		if(parseInt(value) <= 0)
		{
			document.getElementById("show_dir").innerHTML="";
			return;	
		}
		var xmlhttp;
		/*
		...
		*/
		...
		xmlhttp.onreadystatechange=function()
		  ...
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			{
				document.getElementById("show_dir").innerHTML=xmlhttp.responseText;
			}
		  }
		xmlhttp.open("POST","ajax/order_details_dir.php",true);
		xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xmlhttp.send("value="+value);
	}
</script>
...
<script type="text/javascript">
function demand_details(demandno,status)
{
	...
	xmlhttp.open("POST","ajax/demand_details.php",true);
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	xmlhttp.send("demandno="+demandno+"&status="+status);
}
</script>
	...
	<div id="templatemo_content">
        ...
        <!-- start of middle column -->
   	  ...
   	  <div id="templatemo_middle_column">
        	...
        	<h1 class="style1" style=" font-size:16px;">Search Demands&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1>
          <p>&nbsp;</p>
<br><br>
          <div id="master">
  ...
  <tr>
    <td width="120" align="left">Search Type:</td>
    <td width="250" align="left">
    <select id="type" name="type">
    <option value="">Select By</option>
      <option value="D">Demand No</option>
      <option value="S">Supplier Name</option>
      </select></td>
    <td width="120" align="left">Search:</td>
    <td width="250" align="left">
    <input type="text" name="cname" size="30" value="" id="inputString" onkeyup="search_demand(this.value);" /></td>
  </tr>
  </table>
  </form>
</div><br><br>	<!-- end of master division -->

<div id="demand" style="overflow:auto; height:150px;">

</div>	<!-- end of entry division -->

<div id="demand_detail" align="center">
