  ...
  <tr>
    ...
    <td><select id="group_type" name="group_type">
                  ...
                  <?php
					...
					while($i < $num)
					{
						$group_type_id = mysql_result($result,$i, "GROUP_TYPE_ID" );
						$group_type = mysql_result($result,$i, "GROUP_TYPE" );
			?>
...
<?php	
				...
				else
				{
					...
					{
						$quer = "INSERT INTO login_tab VALUES('$rest_id', '0', '$userid', '$passwd','$group_id', '$group_type_id', 'logout', 'E', '00:00:00','$created_id', '$date_time', '$created_id', '$date_time')";
						mysql_query($quer) or die ('Login Query failed!'.mysql_error());
						...
						mysql_query($quer) or die ('User Query failed!'.mysql_error());
