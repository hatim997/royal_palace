...
<!-- start of content -->
	...
	<div id="templatemo_content">
    	...
    	<div id="templatemo_middle_column">
			...
			if(isset($_POST['submit']))
			{
				...
				$query = "SELECT max(INGREDIENT_ID) FROM ingredient_tab";
  ...
  <tr>
    <td>Dish</td>
    <td><select id="unit_id" name="unit_id" onchange="loadDoc(this.value)"><option value="">Select Dish</option>
                <?php
  ...
  <tr>
    <td>Ingerdient</td>
    <td><select id="unit_id" name="unit_id" onchange="loadDoc(this.value)"><option value="">Select Ingerdient</option>
                <?php
