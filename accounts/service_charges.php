...
<h1 class="style1" style="font-size:16px;">New Service Charges &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
            
            <?php
			if(isset($_POST['submit']))
			{
				$restid = $_SESSION['restid'];
				$query = "SELECT max(SERVICE_ID) FROM service_charges_history";
				...
				while($i < $num1)
				{
					$service_id = mysql_result($result,$i, "max(SERVICE_ID)" );
					$i++;
				}
				$service_id++;
				...
				$query = "INSERT INTO service_charges_history 
				VALUES('$restid','$service_id','$service_detail','$service_value','$charges_on_date','$charges_off_date','$created_id','$date_time','$created_id','$date_time')";
					
				mysql_query($query) or die('Insertion Failed:'.mysql_error());
				echo '<h4 class="style9">Service Successfully Defined</h4><br><br>';
				?>
  ...
  <tr>
    <td width="100">Service Detail:</td>
    <td width="250"><textarea rows="2" name="service_detail" id="service_detail" cols="20">
  ...
  <tr>
    <td>Service Value:</td>
    <td><input type="text" name="service_value" id="service_value" />&nbsp;&nbsp;in Percentage(%)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>Service Value:</td>
    <td><input type="text" name="service_value" id="service_value" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
