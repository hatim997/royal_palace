...
<!-- start of content -->
	...
	<div id="templatemo_content">
		...
		<ul>
            ...
            <li><a href="new_kitchen.php">New Kitchen</a></li>
            <li><a href="food_type.php">New Food Type</a></li>
            <li><a href="dish_master_admin.php">New Dish</a></li>
            <li><a href="ingredient_master.php">New Ingredient</a></li>
            <li><a href="unit_master.php">New Unit</a></li>
            <li><a href="new_membership.php">New Membership</a></li>
            <li><a href="new_guest_add.php">New Guest</a></li>
            <li><a href="order_master.php">New Order</a></li>
            <li><a href="main_acct.php">New Account</a></li>
             <li><a href="ctrl_acct.php">Control Account</a></li>
             <li><a href="scat1_acct.php">Sub Category1 Account</a></li>
            <li><a href="edit_order.php">Edit Order</a></li>
            <li><a href="dish_new_charges.php">New Dish Charges</a></li>
            <li><a href="dish_charges.php">Edit Dish Charges</a></li>
            <li><a href="ingredient_store.php">Ingredient Store</a></li>
            <li><a href="ingredient_adjustment.php">Store Adjustment</a></li>
            <li><a href="updates.php">Add Notice</a></li>
            <li><a href="sales_ledger.php">Sales Ledger</a></li>
            <li><a href="cash_ledger.php">Cash Ledger</a></li>
            <li><a href="rpt_dish_sale.php">Dish Wise Cost & Sale</a></li>
            <li><a href="rpt_revenue_collection.php">Revenue Collect. by Order</a></li>
            <li><a href="rpt_daily_rev_collection.php">Revenue Collect. by Date</a></li>
            <li><a href="rpt_ost_revenue.php">Outstanding Revenue</a></li>
            <li><a href="forcelogout.php">User Logout</a></li>
    	...
    	<div id="templatemo_middle_column">
        	...
        	<h1 class="style1" style=" font-size:16px;">Welcome to Web Saucer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br />
