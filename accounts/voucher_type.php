...
function validate() 
{
	if (document.unit.type.value.length < 1)
	{
		alert("Please enter voucher type.");
		return false;
	}
	if (document.unit.type.value.length > 3)
	{
		alert("Voucher type must be less than four characters.");
		return false;
	}
	if (parseInt(document.unit.type.value))
	{
		alert("Voucher type must be characters.");
		return false;
	}
	if (document.unit.title.value.length < 1)
	{
		alert("Please enter voucher title.");
		return false;
	}
	if (document.unit.flag.value == "")
	{
		alert("Please select correct treat with value.");
		return false;
	}
...
<h1 class="style1" style="font-size:16px;">New Voucher Type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
			...
			if(isset($_POST['submit']))
			{
				...
				$flag = $_POST['flag'];
				$query = "INSERT INTO voucher_type(VOUCHER_TYPE, VOUCHER_TITLE, TREAT_WITH, CREATED_ID, CREATED_ON, EDITED_ID, EDITED_ON)
				VALUES('$type','$title','$flag','$created_id','$date_time','$created_id','$date_time')";
					
				mysql_query($query) or die('Insertion Failed:'.mysql_error());
				echo '<h4 class="style9">Voucher Type Successfully Defined</h4><br><br>';
				?>
            
            
            <form name="unit" method="post" action="" id="unit" onsubmit="return validate();">
            <table width="350" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="104">Voucher Type:</td>
    <td width="246"><input type="text" name="type" id="type" /></td>
  </tr>
  <tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  ...
  <tr>
    <td width="104">Voucher Title:</td>
    <td width="246"><input type="text" name="title" id="title" /></td>
  </tr>
  <tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
