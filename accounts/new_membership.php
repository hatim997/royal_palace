...
<h1 class="style1" style="font-size:16px;">New Membership Type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
            
            <?php
			if(isset($_POST['submit']))
			{
				
				$query = "SELECT max(MEMBERSHIP_ID) FROM membership_tab";
				...
				while($i < $num1)
				{
					$mem_id = mysql_result($result,$i, "max(MEMBERSHIP_ID)" );
					$i++;
				}
				$mem_id++;
				...
				$query = "INSERT INTO membership_tab 
				VALUES('$mem_id','$membership','$discount','$created_id','$date_time','$created_id','$date_time')";
					
				mysql_query($query) or die('Insertion Failed:'.mysql_error());
				echo '<h4 class="style9">Membership Successfully Defined</h4><br><br>';
				?>
