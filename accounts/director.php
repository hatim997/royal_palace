...
<h1 class="style1" style="font-size:16px;">Add Director &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
			...
			if(isset($_POST['submit']))
			{
				...
				$query = "SELECT max(DIRECTOR_ID) FROM directors_tab";
				...
				while($i < $num1)
				{
					$director_id = mysql_result($result,$i, "max(DIRECTOR_ID)" );
					$i++;
				}
				$director_id++;
				
				
				$query = "INSERT INTO directors_tab VALUES('$director_id','$director','$company','$created_id','$date_time','$created_id','$date_time')";
				mysql_query($query) or die('Master Insertion Failed:'.mysql_error());
				
				
				echo '<h4 class="style9">Director Successfully Added</h4><br><br>';
				?>
  ...
  <tr>
    <td>Company</td>
    <td><textarea rows="2" name="company" id="company" cols="20"></textarea></td>
  </tr>
