    ...
    <td width="210"><select id="expense_type" name="expense_type" onchange="show_expense_item(this.value)">
  		<option value="">Select Expense Type</option>
			<?php
                ...
                while($i < $num)
                {
                    $ingredient_name = mysql_result($result,$i, "EXPENSE_TYPE_NAME");
                    $ingredient_id = mysql_result($result,$i, "EXPENSE_TYPE_ID");
            ?>
    ...
    <td width="210"><select id="director" name="director">
        ...
        <option value="0">None</option>
			<?php
                ...
                while($i < $num)
                {
                    $ingredient_name = mysql_result($result,$i, "DIRECTOR_NAME");
                    $ingredient_id = mysql_result($result,$i, "DIRECTOR_ID");
            ?>
              <option value="<?php echo $ingredient_id; ?>"><?php echo $ingredient_name; ?></option>
            <?php
