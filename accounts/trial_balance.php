...
<!-- start of content -->
	...
	<div id="templatemo_content">
        ...
        <div id="dialog" title="Help Trial Balance">
<p>All the postings are shown in tabular form and with all the debits and credits equal.<br>
<img src="images/gap/trial_balance.jpg" /></p>
</div>
       
    	  <h1 class="style1" style=" font-size:16px;">Trial Balance<img src="images/help.png" height="25" width="25" alt="Help" title="Help" id="opener" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="height:50px; width:1000px; " align="center ">
  ...
  <tr>
      ...
      <td width="196"><input type="text" id="to_date"></td>
