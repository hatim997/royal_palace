...
<script type="text/javascript">
	function show_item(value)
	{
		...
		xmlhttp.open("POST","ajax/show_item_form.php",true);
...
<h1 class="style1" style="font-size:16px;">Select Item Against Supplier&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1>
<br>
			...
			if(isset($_POST['submit']))
			{
				...
				$query = "INSERT INTO supplier_item 
				VALUES('$s_id','$i_id','$created_id','$date_time','$created_id','$date_time')";
...
$query = "SELECT * from supplier_master WHERE REST_ID = '$rest_id' ORDER BY SUPPLIER_ID";
$result = mysql_query($query) or die("Error: ".mysql_error());
$num = mysql_num_rows($result);//get total number of records
$i = 0;
while($i < $num)//check till i is less than number of records
{
	$id = mysql_result($result, $i, "SUPPLIER_ID");//from the array[$i] pick column(disease_id)
	$name=mysql_result($result,$i,"SUPPLIER_NAME");
...
<table width="350" align="center" border="0" cellspacing="0" cellpadding="0">
    <tr>
  <td width="117">&nbsp;</td>
  <td width="233"><input class="button" align="left" onclick="return check();" name="submit" style="cursor:pointer" type="submit" value="Submit" /><input type="reset" class="button" style="cursor:pointer" name="reset" value="Reset"></td>
  </tr>
</table>
</div>
</form><br>        
