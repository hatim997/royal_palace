...
<h1 class="style1" style="font-size:16px;">Expense Type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
			...
			if(isset($_POST['submit']))
			{
				...
				$query = "SELECT max(EXPENSE_TYPE_ID) FROM expense_type_tab";
				...
				while($i < $num1)
				{
					$expense_id = mysql_result($result,$i, "max(EXPENSE_TYPE_ID)" );
					$i++;
				}
				$expense_id++;
				
				
				$query = "INSERT INTO expense_type_tab VALUES('$expense_id','$expense','$expense_detail','$created_id','$date_time','$created_id','$date_time')";
				mysql_query($query) or die('Master Insertion Failed:'.mysql_error());
				
				
				echo '<h4 class="style9">Expense Successfully Added</h4><br><br>';
				?>
  ...
  <tr>
    ...
    <td><textarea rows="2" name="expense_detail" id="expense_detail" cols="20"></textarea></td>
  </tr>
