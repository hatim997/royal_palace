...
<h1 class="style1" style="font-size:16px;"><strong>Add Updates</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
          ...
          <p align="justify" class="em_text"><?php
			if(isset($_POST['submit']))
			{
				...
				$query = "SELECT max(NOTICE_ID) FROM notice_board_tab";
				...
				while($i < $num)
				{
					$notice_id = mysql_result($result,$i, "max(NOTICE_ID)" );
					$i++;
				}
				$notice_id++;
				
					
					$query = "INSERT INTO notice_board_tab VALUES('$notice_id','$notice_title','$notice_detail','$start_time','$end_time','$time','E','$created_id','$date_time','$created_id','$date_time')";
