...
<h1 class="style1" style="font-size:16px;">New Dish &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
			...
			if(isset($_POST['submit']))
			{
				...
				while($i < $num1)
				{
					$dish_id = mysql_result($result,$i, "max(DISH_ID)" );
					$i++;
				}
				$dish_id++;
				
				$query = "SELECT max(DISH_CHARGES_ID) FROM dish_charges_history";
				$result = mysql_query($query);
				$num1 = mysql_numrows($result);
				//mysql_close();
				//$num1--;
				...
				while($i < $num1)
				{
					$dish_charges_id = mysql_result($result,$i, "max(DISH_CHARGES_ID)" );
					$i++;
				}
				$dish_charges_id++;
				
				$query = "INSERT INTO dish_master_tab VALUES('$rest_id','$kit_id','$food','$dish_id','$dish','$dish_detail','$serving','$cook_time','$dish_charges_id',
				'$created_id','$date_time','$created_id','$date_time')";
				mysql_query($query) or die('Master Insertion Failed:'.mysql_error());
				
				$query = "INSERT INTO dish_charges_history VALUES('$rest_id','$dish_id','$dish_charges_id','$charges','$charges_on_date','$charges_off_date',
				'$created_id','$date_time','$created_id','$date_time')";
  ...
  <tr>
    ...
    <td><select id="food" name="food">
      ...
      <?php
					...
					while($i < $num)
					{
						$food_id = mysql_result($result,$i, "FOOD_TYPE_ID");
						$food_type_detail = mysql_result($result,$i, "FOOD_TYPE_DETAIL");
				?>
  ...
  <tr>
    <td>Dish Detail</td>
    <td><textarea rows="2" name="dish_detail" id="dish_detail" cols="20"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
