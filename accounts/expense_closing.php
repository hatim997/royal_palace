...
<h1 class="style1" style="font-size:16px;">Expense Closing&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
			...
			if(isset($_POST['submit']))
			{
				...
				$expense_clo_dt = $_POST['expense_clo_dt'];
				$expense_clo_detail = $_POST['expense_clo_detail'];
				
				$query = "SELECT max(EXPENSE_CLOSING_ID) FROM expense_closing_history";
				...
				while($i < $num1)
				{
					$expense_clo_id = mysql_result($result,$i, "max(EXPENSE_CLOSING_ID)" );
					$i++;
				}
				$expense_clo_id++;
				
				
				$query = "INSERT INTO expense_closing_history VALUES('$expense_clo_id','$expense_clo_dt','$expense_clo_detail','$created_id','$date_time','$created_id','$date_time')";
				mysql_query($query) or die('Master Insertion Failed:'.mysql_error());
				
				
				echo '<h4 class="style9">Expense Closing Successfully Added</h4><br><br>';
				
				$update = "UPDATE expense_closing_tab SET LAST_EXPENSE_CLOSING_DATE = '$expense_clo_dt', EDITED_ID = '$user', EDITED_ON = '$date_time'";
  ...
  <tr>
    <td>Expense Closing Date:</td>
    <td><input type="text" name="expense_clo_dt" class="tcal" id="expense_clo_dt" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>Expense Closing Detail</td>
    <td><textarea rows="2" name="expense_clo_detail" id="expense_clo_detail" cols="20"></textarea></td>
  </tr>
