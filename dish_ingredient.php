	...
	<div id="templatemo_container">
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_left_column">
					...
					<div class="leftcolumn_box01_bottom">
						<div id="menu2" class="form_row">
							<ul>
								...
								<li><a href="clients_dues.php">Add Remaining Dues</a></li>
				...
				<div id="abc1">
					<div class="abc">
						...
						<br><?php //include("includes/right.php"); 
							?><br><br>
					</div>
				</div>
			...
			<div id="templatemo_middle_column">
				...
				<h1 class="style1" style="font-size:16px;">Web Saucer Ingredeint &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>

				<?php
				if (isset($_POST['submit'])) {

					// Assume $conn is your mysqli connection
					$query = "SELECT max(INGREDIENT_ID) as max_id FROM ingredient_tab";
					$result = mysqli_query($conn, $query);
					$row = mysqli_fetch_assoc($result);
					$ingredient_id = $row['max_id'] + 1;

					$created_id = $_SESSION['username'];
					$ingredient_name = $_POST['ingredient_name'];
					$unit_id = $_POST['unit_id'];
					$date_time = date('Y-m-d H:i:s'); // add this if not defined earlier

					$query = "INSERT INTO ingredient_tab 
        VALUES('$ingredient_id','$ingredient_name','$unit_id','$created_id','$date_time','$created_id','$date_time')";
				...
				?>
					...
					<form name="ingredient" method="post" action="" id="ingredient_name" onsubmit="return validate();">
						<table width="350" align="center" border="0" cellspacing="0" cellpadding="0">

							<tr>
								<td>Dish</td>
								<td><select id="unit_id" name="unit_id" onchange="loadDoc(this.value)">
										<option value="">Select Dish</option>
										<?php
										$query = "SELECT * FROM dish_master_tab ORDER BY DISH_NAME ASC";
										$result = mysqli_query($conn, $query) or die("Failed: " . mysqli_error($conn));
										$num = mysqli_num_rows($result);
										$i = 0;
										while ($i < $num) {
											$row = mysqli_fetch_assoc(mysqli_data_seek($result, $i) ? $result : null);
							...
							<tr>
								<td>Ingerdient</td>
								<td><select id="unit_id" name="unit_id" onchange="loadDoc(this.value)">
										<option value="">Select Ingerdient</option>
										<?php
										...
										$i = 0;
										while ($i < $num) {
											mysqli_data_seek($result, $i); // Move internal pointer to $i
											$row = mysqli_fetch_assoc($result);
						...
						<table width="350" align="center" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><select id="unit_id" name="unit_id" onchange="loadDoc(this.value)">
										...
										$i = 0;
										while ($i < $num) {
											mysqli_data_seek($result, $i); // Move pointer to specific row
											$row = mysqli_fetch_assoc($result); // Fetch that row
											$dish_name = $row["DISH_NAME"];
											$dish_id = $row["DISH_ID"];
										?>
							...
							<tr>
								...
								<td><select id="unit_id" name="unit_id" onchange="loadDoc(this.value)">
										...
										$i = 0;
										while ($i < $num) {
											mysqli_data_seek($result, $i); // move to the specific row
											$row = mysqli_fetch_assoc($result); // fetch row as associative array
											$ingredient_name = $row["INGREDIENT_NAME"];
											$ingredient_id = $row["INGREDIENT_ID"];
										?>
