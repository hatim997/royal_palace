...
if (isset($_REQUEST['view'])) {
  ...
  foreach ($_REQUEST['radiobox'] as $order_id) {
    $sql1 = "SELECT * FROM banq_order_master WHERE ORDER_NO = ?";
    $stmt1 = mysqli_prepare($conn, $sql1);
    mysqli_stmt_bind_param($stmt1, "s", $order_id);
    mysqli_stmt_execute($stmt1);
    $result1 = mysqli_stmt_get_result($stmt1);

    // Fetch the row for the current order_id
    if ($row = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
      // Store the last valid row (if multiple order_ids, last one is kept)
      $id = $row['BANQ_ID'];
  ...
  for ($i = 1; $i <= 8; $i++) {
    if (isset($_POST[$i])) {
      ...
      $mbooking_status = isset($_POST['booking_status']) ? $_POST['booking_status'] : '';
    }
  }
}
      ...
      <form name="form1" id="form1" action="ajax/banq_order_book.php" method="post" onsubmit="return validateForm()">
          ...
          <table width="231" border="0">
            ...
            <tr>
              ...
              <td width="127">
                ...
                <p align="justify">
                  <?php
                  $query = "SELECT * FROM banq_master_tab WHERE banq_master_tab.BANQ_ID NOT IN (
        ...
        <div id="mid2column_box">
          ...
          <table width="277">
            ...
            <tr>
              ...
              <th>
                <div align="justify">Total Received</div>
              </th>
            </tr>
            <tr>
              <th>
        ...
        <div id="mid3column_box">
          <table border="0">
            ...
            <tr>
              <td>
                <h1 style=" font-size:18px; color:#F00;"> Net Payable
            ...
            <tr>
              ...
              <td width="139">
                ...
                WHERE banq_master_tab.BANQ_ID NOT IN (
                  SELECT BANQ_ID FROM banq_order_master 
                  WHERE BOOKING_STATUS='B' AND FUNCTION_DATE='$date' 
                  AND TIME_FROM='$time_from' AND ORDER_NO!='$order_id'
                ) 
                AND banq_master_tab.BANQ_ID != '$id'";
          ...
          <div id="add_hall_div">
            ...
            ?>
              <table width="234">
                ...
                WHERE banq_master_tab.BANQ_ID NOT IN (
                  SELECT BANQ_ID FROM banq_order_master 
                  WHERE BOOKING_STATUS='B' AND FUNCTION_DATE='$add_date' 
                  AND TIME_FROM='$time_from' AND ORDER_NO!='$order_id'
                )";
        ...
        <div id="mid1column_box">
          ...
          <div id="mode1">
            <table>
              ...
              $qq1 = "SELECT SUM(SCHEME_QTY) AS total_reserved FROM banq_color_scheme_history WHERE SCHEME_ID = '$s_id' AND FUNCTION_DATE='$date_r' ";
