...
function hall_availability()
    {
	var function_date = document.getElementById("date11").value;
...
<script>
function deleteAll() {
	var menu = document.getElementById("menu_order1");
	if (menu == null) return;
	if (menu.options == null) return;
...
<table width="231" border="0">
  <tr>
  <th width="94"><div align="justify">Function Id</div></th><input  hidden="" type="text" id="testing" value="" />
  ...
  <th width="94"><div align="justify">Function Date</div></th>
    <td width="127"><div align="justify">
     <input type="hidden" name="f_date" id="f_date" value="<?php echo $date; ?>"/>
      <input readonly="readonly" type="text" size="10" name="date11" id="date11" value="<?php echo $date; ?>" onchange="date_check1(this.value);"/>
...
<input name="del_all" type="button" value="Delete All" onclick="deleteAll();" style="background: #F30; color:#000; font-weight:700;"/>
</td>
</tr>
...
<table width="300" border="0" >
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv1" type="text" size="10" pattern="[0-9]+" id="adv1"  class="advance" onchange=" pass_validation(); generate_cr('ins1'); calculate_total('advance','advance_total'); recieved_amount('adv1','tot_rec'); diff('grand_tot','tot_rec','net');"/></div></td>
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv2" type="text" size="10" pattern="[0-9]+" id="adv2"   class="advance" onchange=" pass_validation(); generate_cr_admin2('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec'); diff('grand_tot','tot_rec','net');"/></div></td>
 ...
 <th><div align="justify">Total Recieved</div></th>
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3"   class="advance" onchange=" pass_validation(); generate_cr_admin3('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec'); diff('grand_tot','tot_rec','net');"/></div></td>
...
<?php } ?>
  ...
  <tr>
    <td><div style="display:none" id="printing" align="justify">
    ...
    <td width="139">
      <div align="justify">
        ...
        <?php
		 ...
		 WHERE banq_order_master.ORDER_NO = '$order_id' AND banq_order_master.FUNCTION_DATE = '$date_r'
		 AND banq_order_master.BANQ_ID='$id' AND banq_master_tab.BANQ_ID='$id'";
            $result123 = mysql_query($query123);
			$row1=mysql_fetch_array($result123)
			?>
          <option value="<?php echo $row1['BANQ_ID']; ?>"><?php echo $row1['BANQ_NAME']; ?></option>
...
$result21= mysql_query($query21) or die('Selection Failed:'.mysql_error());	
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv1" type="text" size="10"  pattern="[0-9]+" id="adv1"  class="advance" onchange="pass_validation(); generate_cr('ins1'); calculate_total('advance','advance_total'); recieved_amount('adv1','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row21['INSTALMENT_AMOUNT']; ?>"/></div></td>
...
$result22= mysql_query($query22) or die('Selection Failed:'.mysql_error());	
  ...
  ?>
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv2" type="text" size="10"  pattern="[0-9]+" id="adv2"  class="advance" onchange=" pass_validation(); generate_cr_admin2('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row22['INSTALMENT_AMOUNT']; ?>"/></div></td>
...
$result23= mysql_query($query23) or die('Selection Failed:'.mysql_error());	
  ...
  ?>
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3"  class="advance" onchange=" pass_validation(); generate_cr_admin3('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row23['INSTALMENT_AMOUNT']; ?>"/></div></td>
...
<table width="500" border="0" >
    ...
    <tr><div style="width:250px;"><strong>
	<?php echo $row11['BANQ_NAME'];if($time_from=="12:00:00" && $time_to =="17:00:00") { echo '&nbsp;(LUNCH)';}
    else
    {
    echo '&nbsp;(DINNER)';
    }?>
    ...
    <tr><div style="width:500px"><strong>Bill Date: </strong> <?php echo $todayy;  ?></div></tr>
	
    <tr><div style="width:500px"><strong>Order No: </strong><?php echo $order_id; ?></div></tr>
    
    <tr><div style="width:500px"><strong>Guest: </strong><?php echo $ans5['GUEST_NAME']; ?></div></tr>
    
    <tr><div style="width:500px"><strong>Function Date: </strong><?php echo $date_r; ?></div></tr>
    
  	<tr>
    <td><strong>No. of Persons: </strong></td><td><?php echo $ans5['guest_guranteed']; ?></td></tr>
    
    <tr><td><strong>Hall Rental:</strong> </td><td><?php echo $ans5['hall_adv']; ?></td></tr>
    
    <tr>
    <td width="100"><strong>Cold Drinks:</strong> </td><td width="50"><?php echo $ans5['Drink_no']; ?></td>
    <td width="40"><strong>Rate:</strong> </td><td width="50"><?php echo $ans5['Drink_rate']; ?></td>
    <td width="40"><strong>Total:</strong> </td><td width="50"><?php echo $ans5['Drink_rate_total']; ?></td>
    </tr>
    
    <tr>
    <td><strong>Tea:</strong> </td><td><?php echo $ans5['tea_no']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo $ans5['tea_rate']; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['tea_rate_total']; ?></td>
    </tr>
    
    <tr>
    <td><strong>Mineral Water:</strong> </td><td><?php echo $ans5['water_no']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo $ans5['water_rate']; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['water_rate_total']; ?></td>
    </tr>
    
    
    <tr><div style="width:500px">
    <td><strong>Table Setting:</strong> </td><td><?php echo $ans5['tableset_no']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo $ans5['tableset_rate']; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['tableset_rate_total']; ?></td></div>
    </tr>
          
    <tr>
    <td><strong>Extras:</strong> </td><td><?php echo $ans5['extra']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['extra']; ?></td>
    </tr>
        
    <tr>
    <td><strong>Tax:</strong> </td><td><?php echo $ans5['tax_total']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['tax_total']; ?></td>
    </tr>
          
    
    <tr>
    <td><strong>Service Charges:</strong> </td><td><?php echo $ans5['service']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['service_total']; ?></td>
    </tr>
    
    
    <tr>
    <td><strong>Stage Amount:</strong> </td><td><?php echo $ans5['stage_amount']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['stage_amount']; ?></td>
    </tr>
    
    
    <tr>
    <td><strong>Sound Amount:</strong> </td><td><?php echo $ans5['sound_amount']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['sound_amount']; ?></td>
    </tr>
    
    
    <tr>
    <td><strong>Video Amount:</strong> </td><td><?php echo $ans5['video_amount']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['video_amount']; ?></td>
    </tr>
    
    
    <tr>
    <td><strong>Misc Amount:</strong> </td><td><?php echo $ans5['misc_amount']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['misc_amount']; ?></td>
    </tr>
    
    
    <tr>
    <td><strong>Discount:</strong> </td><td><?php echo $ans5['DISCOUNT_DETAIL']; ?></td>
    <td><strong>Rate:</strong> </td><td><?php echo '---'; ?></td>
    <td><strong>Total:</strong> </td><td><?php echo $ans5['DISCOUNT_DETAIL']; ?></td>
    </tr>
    <tr>
    <td>&nbsp;</td><td>&nbsp;</td>
    <td>&nbsp;</td><td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td style="font-size:16px"><strong>Grand Total:</strong> </td><td>&nbsp;</td><td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td style="font-size:16px"><strong>Total Received:</strong> </td><td>&nbsp;</td><td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td style="font-size:18px"><strong>Net Payable:</strong> </td><td>&nbsp;</td><td>&nbsp;</td>
...
<?php } ?>
  ...
  <td><h1 style=" font-size:18px; color:#F00;"> Net Payable <input name="net" type="text" size="10" readonly="readonly" id="net" style="font-size:22px; font-weight:900; color:#F00;"
   value="<?php
    if ($ans5['adv_total']!=0){
   echo $ans5['grand_total']-$ans5['adv_total'];
   }
