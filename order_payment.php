...
libs/jquery/1.3.0/jquery.min.js"></script>
	...
	<script type="text/javascript">
		...
		*/
			...
			xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xmlhttp.send("value=" + value + "&gross=" + gross + "&service=" + service + "&tax=" + tax + "&gid=" + gid + "&orderno=" + orderno);
		}
	</script>
	...
	<script type="text/javascript">
		function payment_reception(form) {
			...
			xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xmlhttp.send("orderno=" + orderno + "&gid=" + gid + "&gross=" + gross + "&discount=" + discount + "&service=" + service + "&taxid=" + taxid + "&rec_amount=" + rec_amount + "&p_mode=" + p_mode + "&chequeno=" + chequeno + "&cardno=" + cardno + "&head=" + head + "&discount_details=" + discount_details + "&bank=" + bank);
		}
	</script>
	<script type="text/javascript">
		var clicked = false;
