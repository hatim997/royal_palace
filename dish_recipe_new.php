			...
			<table width="1250" align="left">
				<tr>
					<td width="519" align="left">
						<h1 class="style1" style=" font-size:16px;">Dish Recipe</h1>
					</td>
					<td width="719" align="right"><a href="login.php" style="font-size:18px; font-style:oblique;">Back</a></td>
				</tr>
			</table>
							...
							<td width="146" align="left">
								<select style="width:145px;" id="ing_name" name="ing_name">
									...
									while ($row = mysqli_fetch_assoc($result1)) {
										...
										$unit_id = $row["UNIT_ID"]; // Optional if needed later
