...
<head>
	...
	<script language="javaScript" type="text/javascript">
		function search_ledger() {
			...
			xmlhttp.open("POST", "ajax/a_collection_report_by_function.php", true);
...
<body>
	<div id="process" style="margin-left:10px;">
		<h1 style="font-size:18px; color:#013c54;">Banquet Collection Report By Function</h1>
		<div id="inventory">
			...
			<table width="850" align="left">
				<tr>
					...
					<td width="99" align="left" style="font-weight:800; font-size:16px; "><a href="banq_admin.php"><strong>Main Menu</strong>
						</a></td>
