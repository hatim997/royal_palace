		...
		<div id="templatemo_content">
			...
			<div id="templatemo_middle_column">
              ...
              ORDER BY ORDER_NO ASC";
											...
											$result1 = mysqli_query($conn, $query) or die('Sale failed! ' . mysqli_error($conn));
											$num = mysqli_num_rows($result1);
											$i = 0;
											while ($i < $num) {
												mysqli_data_seek($result1, $i);
												$row = mysqli_fetch_assoc($result1);
												$sale = $row["TOTAL_CHARGES"];
												$total_sale += $sale;
												$total_orders++;
												$i++;
											}
              ...
              ORDER BY INVOICE_NO ASC";
											...
											$result1 = mysqli_query($conn, $query) or die('Invoice failed! ' . mysqli_error($conn));
											$num = mysqli_num_rows($result1);
											$i = 0;
											while ($i < $num) {
												mysqli_data_seek($result1, $i);
                        ...
                        <td align="center"><?php //echo $sample_id;
											?></td>
						<td align="center"><?php //echo $test_req; 
											?></td>-->
												<!--<td align="center"><input type="submit" name="<?php //echo $i; 
																									?>" value="Details" /></td>-->
											</tr>
										<?php
