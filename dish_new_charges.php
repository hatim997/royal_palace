  ...
  <div id="templatemo_container">
    ...
    <div id="templatemo_content">
      ...
      <div id="templatemo_middle_column">
        ...
        <h1 class="style1" style="font-size:16px;"> New Dish Charges&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1><br>
        ...
        if (isset($_POST['submit'])) {
          ...
          $query1 = "SELECT max(DISH_CHARGES_ID) AS max_id FROM dish_charges_history";
          $result1 = mysqli_query($conn, $query1) or die("Query Failed: " . mysqli_error($conn));

          $cid = 1; // default if table is empty
          if ($row = mysqli_fetch_assoc($result1)) {
            $cid = $row['max_id'] + 1;
          }

          // Insert new dish charge record
          $query = "INSERT INTO dish_charges_history 
            VALUES('$rest_id', '$dish', '$cid', '$charges', '$charges_on_date', '$charges_off_date', 
                    '$created_id', '$date_time', '$created_id', '$date_time')";

          mysqli_query($conn, $query) or die('Insertion Failed: ' . mysqli_error($conn));

          echo '<h4 class="style9">Dish Charges Defined Successfully</h4><br><br>';
        ?>
          ...
          <form name="dish" method="post" action="" id="dish" onsubmit="return validate();">
            <table width="350" align="center" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="120">Food:</td>
                <td width="230">
                  <select name="food" onchange="show_dish(this.value)">
                    <option value="">Select Food</option>
                    <?php
                    // Ensure $conn is your active MySQLi connection
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      $dish_id = $row['FOOD_TYPE_ID'];
                      $dish_name = $row['FOOD_TYPE_DETAIL'];
                    ?>
            ...
            <table width="350" align="center" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="120">Dish Charges:</td>
                <td width="230"><input type="text" name="charges" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td width="120">Charges on Date:</td>
                <td width="230"><input type="text" class="tcal" id="charges_on_date" name="charges_on_date" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td width="230">
                  <select name="food" onchange="show_dish(this.value)" ;>
                    <option value="">Select Food</option>
                    <?php
                    // Replace with your actual mysqli connection
                    // Example: $conn = mysqli_connect("localhost", "user", "pass", "database");
