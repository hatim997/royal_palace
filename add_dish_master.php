...
<div id="templatemo_middle_column">
	...
	<body>
		...
		<input type="button" value="Back" style="background-color:#F00; color:#FFF; border-color:#FF0; margin-top:10px; margin-left:535px; " onclick="goBack()">
		...
		if (isset($_POST['submit'])) {
			...
			$dish_detail = isset($_POST['dish_detail']) ? $_POST['dish_detail'] : '';
			$serving = isset($_POST['serving']) ? $_POST['serving'] : '';
			$hour = isset($_POST['hour']) ? $_POST['hour'] : '00';
			$min = isset($_POST['min']) ? $_POST['min'] : '00';
			$charges = isset($_POST['charges']) ? $_POST['charges'] : '';
			$charges_on_date = isset($_POST['charges_on_date']) ? $_POST['charges_on_date'] : '';
			$charges_off_date = isset($_POST['charges_off_date']) ? $_POST['charges_off_date'] : '';
			$cook_time = $hour . ':' . $min;
			...
			$query = "INSERT INTO dish_master_tab VALUES('1','1','20','$dish_id','$dish','$dish_detail','1','00:12:00','99',
