...
<head>
	...
	<script type="text/javascript">
		function transaction_type(value) {
			//var lab_name = encodeURIComponent(document.getElementById("lab_name").value);

			if (value == "") {
				document.getElementById("tran_price").disabled = false;
				document.getElementById("tran_price").value = "";
			...
			document.getElementById("tran_price").disabled = true;
			document.getElementById("tran_price").value = "Disabled";
			document.getElementById("freeze").innerHTML = "Disabled";
		}
	</script>
	...
	<script type="text/javascript">
		function show_inhand(value) {
			...
			xmlhttp.open("POST", "ajax/show_qty_inhand_supplier.php", true);
	...
	<script type="text/javascript">
		function add_inventory(form) {
			...
			var expiry_date = encodeURIComponent(document.getElementById("expiry_date").value);
			...
			if (ingredient_id == "" || tran_id == "" || tran_qty == "" || tran_price == "" || date == "" || detail == "") {
			...
			xmlhttp.open("POST", "ajax/add_inventory_transaction.php", true);
			xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xmlhttp.send("ingredient_id=" + ingredient_id + "&supplier=" + supplier + "&tran_id=" + tran_id + "&tran_qty=" + tran_qty + "&tran_price=" + tran_price + "&date=" + date + "&expiry_date=" + expiry_date + "&detail=" + detail);
		}
	</script>
	<script type="text/javascript">
		var clicked = false;
	...
	<div id="templatemo_container">
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_middle_column">
				...
				<h1 class="style1" style="font-size:16px;">Item Management&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3"><?php echo $today; ?></span></h1>
				<br>
