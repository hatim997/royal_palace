...
//echo $r = $_POST['button1'];
//exit;
$restid = $_SESSION['restid'];
if (isset($_REQUEST['view']) && !empty($_REQUEST['radiobox'])) {
    // Use the first selected order_id (or handle multiple if needed)
    $order_id = $_REQUEST['radiobox'][0]; 
    ...
    if ($result1 && mysqli_num_rows($result1) > 0) {
        ...
        die("No records found for ORDER_NO = $order_id");
    }
} else {
    for ($i = 1; $i <= 8; $i++) {
        if (isset($_POST[$i])) {
...
echo $time_from = $_POST['time_from'];
echo $time_to = $_POST['time_to'];
echo $session  = $_SESSION['f_id'];
exit;
*/
?>
...
-->
  ...
  <script type="text/javascript">
    function hall_availability() {
      ...
      xmlhttp.send("function_date=" + function_date + "&function_time=" + function_time + "&hall=" + hall);
    }
  </script>

  <script type="text/javascript">
    function hall_availability_book() {
      var shift_func = document.getElementById("date1").value;
      var function_time = document.getElementById("func_time").value;
      var hall = document.getElementById("banquet").value;
      var xmlhttp;
      if (window.XMLHttpRequest) { // code for IE7+, Firefox, Chrome, Opera, Safari
  ...
  <script type="text/javascript">
    function pass_validation() {
      ...
      // <!--name.setEchoChar('*');
      // -->
      // <!--var name = prompt("Please enter your password").setEchoChar('*');
      // -->
  ...
  <script type="text/javascript">
    function validateForm() {
      ...
      if (avail == 'HNA') {
        alert("Hall is Already Booked, please choose another hall!");
        return false;
      }
  ...
  <script type="text/javascript">
    function greater_qty(A, B) {
      //alert("ok");
      var one = document.getElementById(A).value; //qty
      var two = document.getElementById(B).value; //available qty
      var net = two - one;
      if (net < 0) {

        alert("quantity cannot be greater than available");

        document.getElementById(A).value = two;
        return;
      } else {
  ...
  <script>
    function generate_cr_admin2(B) {
      ...
      if (ins2 == "") {
        ...
        xmlhttp.open("POST", "ajax/add_cr_num_admin.php", true);
        xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xmlhttp.send();
      } else
        return true;
  ...
  <script type="text/javascript">
    function recieved_amount(A, B) {
      //var total_received = document.getElementById("tot_rec").value;
      //var total_received = document.getElementById("tot_rec").value;
      ...
      //document.getElementById('tot_rec').value = total_received + one;
    }
  </script>


  <script>
    function recieved_amount1(A, B) {
      var one = document.getElementById("tot_rec").value;
      //var one = document.getElementById("advance_total").value;
      var two = document.getElementById("rec_money").value;
      var total = Number(one) + Number(two);
      document.getElementById(B).value = total;
  ...
  <script type="text/javascript">
    function menu_load() {
      var menu_name = encodeURIComponent(document.getElementById("menu_num").value);
      //alert(menu_name);
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#form1').ajaxForm(function() {
        ...
        window.location = "banq_order_master.php";
  ...
  <script>
    function change_time() {
      ...
      alert(function_time);
      //var hall = document.getElementById("banquet").value;
      //alert(function_date+ " and "+ function_time+ " and "+ hall);
    }
  </script>
...
<body>
  ...
  ?>
    ...
    $max_order_no = $row3["max(ORDER_NO)"];
    ?>
    ...
    <div id="templatemo_content">
      ...
      $result1234 = mysqli_query($conn, $query1234);
      $row11 = mysqli_fetch_array($result1234);
      ?>


      <span class="red"><?php echo $row11['BANQ_NAME'];
      ...
      <form name="form1" id="form1" action="ajax/banq_order_book.php" method="post" onsubmit="return validateForm()">
        <div align="center">
          <table border="2">
            <tr>
              <td><input name="book_status" type="radio" value="C" />Cancelled
                &nbsp;<input name="book_status" type="radio" value="T" />Tentative
                &nbsp;<input name="book_status" type="radio" value="B" checked="checked" />Booked</td>
            </tr>
          </table>
        </div>
        <div id="leftcolumn_box">
          ...
          <table width="231" border="0">
            <tr>
              ...
              </th><input hidden="" type="text" id="testing" value="" />
              <td width="127">
                <div align="justify">
              ...
              <td width="127" align="left">
                <div align="justify">
                  <select id="func" name="func">
                    ...
                    <?php
                    $query = "SELECT * FROM function_type_tab ORDER BY FUNCTION_TYPE_NAME ASC";
                    ...
                    while ($i < $num) {
                      ...
                      $foodid = $row["FUNCTION_TYPE_ID"];
                      $food_detail = $row["FUNCTION_TYPE_NAME"];
            ...
            <tr>
              ...
              <td width="127">
                <div align="justify">
                  ...
                  <input type="hidden" size="10" name="date2" id="date2" value="<?php echo $date; ?>" onchange="addhall();" />
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td width="127">
                <div align="justify">
                  ...
                  <select id="banquet" name="banquet" onchange="hall_availability_book()">
                    ...
                    $row1 = mysqli_fetch_array($result123);
                    ?>
            ...
            <tr>
              <th width="94">
                <div align="justify">Additional Hall</div>
              </th>
              <td width="127">
                <div align="justify">
                ...
                <p align="justify">
                  <?php
                  $query = "SELECT * FROM banq_master_tab 
          WHERE banq_master_tab.BANQ_ID NOT IN (
              SELECT BANQ_ID FROM banq_order_master 
              WHERE BOOKING_STATUS='B' AND FUNCTION_DATE='$date' AND TIME_FROM='$time_from'
          ) 
          ...
          <table width="229" border="0">
            ...
            <tr>
              <th>
                <div align="justify">Function Incharge</div>
              </th>
              <td>
                <div align="justify">
          ...
          <table width="325" border="0">
            <tr>
              <th width="95">
                <div align="justify">Select Menu</div>
              </th>
              <td width="196">
                <div align="justify">
                  <select name="menu" id="menu_num" onchange="menu_load();">
                    ...
                    while ($men = mysqli_fetch_array($result4)) {
                    ?>
        ...
        <div id="mid1column_box">
          <table width="229" height="368" border="0">
            ...
            <tr>
              <th>
                <div align="justify">Contact (1)</div>
              </th>
              <td>
                <div align="justify">
            ...
            <tr>
              <th>
                <div align="justify">Contact (2)</div>
              </th>
              <td>
                <div align="justify">
            ...
            <tr>
              <th>
                <div align="justify">Food to be</div>
              </th>
              <td>
                <div align="justify">
                  <p>
            ...
            <tr>
              <th>
                <div align="justify">SPL Notes</div>
              </th>
              <td>
                <div align="justify">
            ...
            <tr>
              <th>
                <div align="justify">Stage No.</div>
              </th>
              <td>
                <div align="justify">
            ...
            <tr>
              <th>
                <div align="justify">Miscellenous</div>
              </th>
              <td>
                <div align="justify">
            ...
            <tr>
              <th>
                <div align="justify">Additional Notes</div>
              </th>
              <td>
                <div align="justify">
        ...
        <div id="mid2column_box">
          ...
          <table width="300" border="0">
            ...
            <tr>
              <th width="149">
                <div align="justify">No. of Person</div>
              </th>
              <td width="65">
                <div align="justify">
            ...
            <tr>
              <th>
                <div align="justify">B. rate</div>
              </th>
              <td>
                <div align="justify"><input name="b_rate" type="text" size="10" id="op1" onchange="calc('op','op1','result'); calculate_total('total','grand_tot');" pattern="[0-9]+" /></div>
              </td>
              <td width="72">
                <div align="justify"><input name="b_rate_total" type="text" size="10" id="result" class="total" readonly="readonly" onchange="calculate_total('total','grand_tot')" /></div>
              </td>
            </tr>
            <tr>
              <th>
                <div align="justify">Hall Rental</div>
              </th>
              <td>
                <div align="justify"><input name="hall_rate" type="text" size="10" id="result6" class="total" onchange="calculate_total('total','grand_tot')" pattern="[0-9]+" /></div>
              </td>
              <th>
                <div align="right"></div>
              </th>
          ...
          <table width="322">
            ...
            <tr>
              <th width="148">
                <div align="justify">Cold Drinks</div>
              </th>
              <td width="46">
                <div align="justify"><input name="drinks" type="text" size="5" id="op2" pattern="[0-9]+" onchange="calc('op2','op3','result1'); calculate_total('total','grand_tot');" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="30">
                <div align="justify"><input name="drinks_rate" type="text" size="5" id="op3" pattern="[0-9]+" onchange="calc('op2','op3','result1'); calculate_total('total','grand_tot');" /></div>
              </td>
              <td width="47">
                <div align="right">
            ...
            <tr>
              <th>
                <div align="justify">Tea</div>
              </th>
              <td>
                <div align="justify"><input name="tea" type="text" size="5" id="op4" pattern="[0-9]+" onchange="calc('op4','op5','result2'); calculate_total('total','grand_tot');" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="30">
                <div align="justify"><input name="tea_rate" type="text" size="5" id="op5" pattern="[0-9]+" onchange="calc('op4','op5','result2'); calculate_total('total','grand_tot');" /></div>
              </td>
              <td width="47">
                <div align="right">
            ...
            <tr>
              <th>
                <div align="justify">Mineral Water</div>
              </th>
              <td>
                <div align="justify"><input name="water" type="text" size="5" id="op6" pattern="[0-9]+" onchange="calc('op6','op7','result3'); calculate_total('total','grand_tot');" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="30">
                <div align="justify"><input name="water_rate" type="text" size="5" id="op7" pattern="[0-9]+" onchange="calc('op6','op7','result3'); calculate_total('total','grand_tot');" /></div>
              </td>
              <td width="47">
                <div align="right">
            ...
            <tr>
              <th height="24">
                <div align="justify">Table Setting</div>
              </th>
              <td>
                <div align="justify"><input name="tset" type="text" size="5" id="op8" pattern="[0-9]+" onchange="same_amount('op8','op','g_grn'); calc1('op8','op9','result4'); calculate_total('total','grand_tot');" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="30">
                <div align="justify"><input name="tset_rate" type="text" size="5" pattern="[0-9]+" id="op9" onchange="calc1('op8','op9','result4'); calculate_total('total','grand_tot');" /></div>
              </td>
              <td width="47">
                <div align="right">
                  <input name="tset_total" type="text" size="7" readonly="readonly" id="result4" class="total" onchange="calculate_total('total','grand_tot')" />
                </div>
              </td>
            </tr>
          </table>
          <table width="265" border="0">
            <tr>
              <th width="150">
                <div align="justify">Extras</div>
              </th>
              <td width="105">
                <div align="justify"><input name="extra" type="text" size="10" id="result5" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" /></div>
              </td>
            </tr>
          </table>
          <table width="324" border="0">
            ...
            <tr>
              ...
              <td width="51">
                <div align="justify"><input name="tax" type="text" size="5" pattern="[0-9]+" id="tax" onchange="tax_calc(); calculate_total('total','grand_tot');" /></div>
              </td>
              <td width="60">
                <div align="justify"><input name="tax_p" type="checkbox" id="tax_p" />%</div>
              </td>
              ...
              <td width="44">
                <div align="justify"><input name="tax_percent" type="text" size="5" class="total" id="tax_tot" onchange="calculate_total('total','grand_tot')" readonly="readonly" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="ser_charge" id="ser_charge" type="text" size="5" pattern="[0-9]+" onchange=" service_calc(); calculate_total('total','grand_tot');" /></div>
              </td>
              <td width="60">
                <div align="justify"><input name="ser_p" type="checkbox" id="ser_p" />%</div>
              </td>
              ...
              <td width="44">
                <div align="justify"><input name="ser_percent" type="text" size="5" class="total" id="ser_tot" onchange="calculate_total('total','grand_tot')" readonly="readonly" /></div>
              </td>
            </tr>
          </table>
          <table width="231" border="0">
            <tr>
              <th width="153">
                <div align="justify">Stage Amount</div>
              </th>
              <td width="68">
                <div align="justify"><input name="stage_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" /></div>
              </td>
            </tr>
            <tr>
              <th>
                <div align="justify">Sound Amount</div>
              </th>
              <td>
                <div align="justify"><input name="sound_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" /></div>
              </td>
            </tr>
            <tr>
              <th>
                <div align="justify">Video Amount</div>
              </th>
              <td>
                <div align="justify"><input name="vid_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" /></div>
              </td>
            </tr>
            <tr>
              <th>
                <div align="justify">Misc Amount</div>
              </th>
              <td>
                <div align="justify"><input name="misc_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="discount" type="text" size="10" id="discount" pattern="[0-9]+" onchange="calculate_discount('discount','grand_tot')" /></div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="grand_total" type="text" size="10" id="grand_tot" readonly="readonly" /></div>
              </td>
            </tr>
          </table>
          ...
          <table width="277">
            <tr>
              ...
              <th width="88">
                <div align="justify">Advance Rs.</div>
              </th>
              <th width="39">
                <div align="justify">CR #</div>
              </th>
              <th width="113">
                <div align="justify">Enter Amount:</div>
              </th>
            </tr>
            <input name="password" type="hidden" id="password" value="<?php echo $password; ?>" />

            <!--  <td> <input  type="password" name="password" id="password"  onfocus="this.value=''" class="login-inp" value="<?php echo $password; ?>" /></td>-->
            <tr>
              <th>
                <div align="justify">CF:</div>
              </th>
              <td>
                <div align="justify"><input name="adv1" type="text" size="10" pattern="[0-9]+" id="adv1" class="advance" onchange=" pass_validation(); generate_cr('ins1'); calculate_total('advance','advance_total'); recieved_amount('adv1','tot_rec'); diff('grand_tot','tot_rec','net');" /></div>
              </td>
              <td>
                <div align="justify"><input name="adv_cr1" type="text" size="5" value="" readonly="readonly" id="ins1" /></div>
              </td>
              <td align="right"><input name="money" type="text" size="10" id="rec_money" onchange=" pass_validation(); recieved_amount('rec_money','tot_rec'); diff('grand_tot','tot_rec','net'); " /></td>
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="adv2" type="text" size="10" pattern="[0-9]+" id="adv2" class="advance" onchange=" pass_validation(); generate_cr_admin2('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec'); diff('grand_tot','tot_rec','net');" /></div>
              </td>
              <td>
                <div align="justify"><input name="adv_cr2" type="text" size="5" value="" readonly="readonly" id="ins2" /></div>
              </td>
              <th>
                <div align="justify">Total Recieved</div>
              </th>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3" class="advance" onchange=" pass_validation(); generate_cr_admin3('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec'); diff('grand_tot','tot_rec','net');" /></div>
              </td>
              <td>
                <div align="justify"><input name="adv_cr3" type="text" size="5" value="" readonly="readonly" id="ins3" /></div>
              </td>
          ...
          <table width="292">
            ...
            <tr>
              <th width="113" align="left">
                <div align="justify">Payment Mode:</div>
              </th>
        ...
        <div id="mid3column_box">
          <table border="0">
            ...
            <tr>
              <td>
                <div style="display:none" id="printing" align="justify">
            ...
            <tr>
              <td>
                <h1 style=" font-size:18px; color:#F00;"> Net Payable <input name="net" type="text" size="10" readonly="readonly" id="net" style="font-size:22px; font-weight:900; color:#F00;" /></h1>
              </td>
            </tr>
          </table>
        </div>
...
-->
          <input name="update" type="submit" value="Update" onclick="diff('grand_tot','tot_rec','net'); selectAll();" style="background: #F30; color:#000; height:35px; width:85px; font-size:16px; font-weight:600; border:groove; border-color:#CCC;" />
          ...
          <!--
<input name="thermal_print" type="button" value="Thermal Print" 
onclick="printSelection(document.getElementById('thermal_print'));" 
style="background: #F30; color:#000; height:35px; width:auto; font-size:16px; font-weight:600; border:groove; border-color:#CCC;"/>-->
        ...
        <div align="center">
          ...
          <table border="2">
            ...
            ?>
              ...
              <tr>
                <td><input name="book_status" type="radio" value="C" checked="checked" />Cancelled
                  &nbsp;<input name="book_status" type="radio" value="T" />Tentative
                  &nbsp;<input name="book_status" type="radio" value="B" />Booked</td>
              </tr>
            <?php } else if ($check_status == "T") {
            ?>
              <tr>
                <td><input name="book_status" type="radio" value="C" />Cancelled
        ...
        <div id="leftcolumn_box">
          ...
          <table width="235" border="0">
            <tr>
              <th width="86">
                <div align="justify">Function Id</div>
              </th><input type="hidden" id="testing" value="" />
              <td width="139">
                <div align="justify">
            ...
            <tr>
              ...
              <td width="139">
                <div align="justify">
                  ...
                  $r2 = mysqli_query($conn, $q2) or die('Query Failed');
                  while ($ans1 = mysqli_fetch_array($r2)) {
            ...
            <td width="139" align="left">
              <div align="justify">
                <select id="func" name="func">
                  ...
                  $r3 = mysqli_query($conn, $q3) or die('Query Failed');
                  while ($ans2 = mysqli_fetch_array($r3)) {
                  ...
                  $num1 = mysqli_num_rows($r3_1);
                  $j = 0;
                  while ($j < $num1) {
                    mysqli_data_seek($r3_1, $j);
                    $row = mysqli_fetch_assoc($r3_1);
                    $foodid1 = $row["FUNCTION_TYPE_ID"];
                    $food_detail1 = $row["FUNCTION_TYPE_NAME"];
            ...
            <tr>
              ...
              <td width="139">
                <div align="justify">
                  ...
                  $rr = mysqli_query($conn, $qq) or die('Not Found:' . mysqli_error($conn));
                  $num = mysqli_num_rows($rr);

                  if (mysqli_num_rows($rr) == 1) {
                    while ($aa = mysqli_fetch_array($rr)) {
                  ?>
                      ...
                      <input type="hidden" name="shift_func" id="shift_func" value="" />
                      <!--  <input type="hidden" name="date1"  id="date1" value="<?php echo $date_r = $aa['FUNCTION_DATE']; ?>"/> -->
              ...
              <td width="139">
                <div align="justify">
                  ...
                  <select id="func_time" name="time" onchange="hall_availability()">
                    ...
                    $result20 = mysqli_query($conn, $query20) or die('Not Found:' . mysqli_error($conn));
            ...
            <tr>
              ...
              <td width="139">
                <div align="justify">
                  ...
                  <select id="banquet" name="banquet" onchange="hall_availability_book()">
                    <?php
                    $query123 = "SELECT banq_master_tab.BANQ_ID, banq_master_tab.BANQ_NAME 
             FROM banq_master_tab, banq_order_master 
             WHERE banq_order_master.ORDER_NO = '$order_id' 
             AND banq_order_master.FUNCTION_DATE = '$date_r' 
             AND banq_order_master.BANQ_ID = '$id' 
             AND banq_master_tab.BANQ_ID = '$id'";
                    $result123 = mysqli_query($conn, $query123);
                    $row1 = mysqli_fetch_array($result123);
                    ?>
...
$query = "SELECT * FROM banq_master_tab 
          WHERE banq_master_tab.BANQ_ID NOT IN (
              SELECT BANQ_ID FROM banq_order_master 
              WHERE BOOKING_STATUS='B' AND FUNCTION_DATE='$date' AND TIME_FROM='$time_from' AND ORDER_NO!='$order_id'
          ) 
          AND banq_master_tab.BANQ_ID != '$id'";
...
while ($i < $num) {
  ...
  $q4 = "SELECT DISTINCT(BANQ_ID) FROM banq_order_master 
         WHERE ORDER_NO='$order_id' AND BANQ_ID = '$o_id' AND FUNCTION_DATE='$date_r'";
          ...
          <div id="add_hall_div">
            ...
            ?>
              ...
              <table width="234">
                <tr>
                  <th width="85">
                    <div align="justify">Hall on Second date</div>
                  </th>
...
$query = "SELECT * FROM banq_master_tab 
          WHERE banq_master_tab.BANQ_ID NOT IN (
              SELECT BANQ_ID FROM banq_order_master 
              WHERE BOOKING_STATUS='B' AND FUNCTION_DATE='$add_date' AND TIME_FROM='$time_from' AND ORDER_NO!='$order_id'
          )";
...
while ($i < $num) {
  ...
  $q4 = "SELECT DISTINCT(BANQ_ID) FROM banq_order_master 
         WHERE ORDER_NO='$order_id' AND BANQ_ID = '$o_id' AND FUNCTION_DATE='$add_date'";
  $r4 = mysqli_query($conn, $q4) or die("Query Failed");
...
$r5 = mysqli_query($conn, $q5) or die('Query Failed');
$ans5 = mysqli_fetch_array($r5);
?>
  ...
  <?php } ?>
            ...
            <tr>
              ...
              <td>
                <select name="menu_order[]" id="menu_order1" size="9" multiple="multiple" style="width:200px">
  <?php
        ...
        <div id="mid1column_box">
          <table width="229" height="368" border="0">
            ...
            <tr>
              ...
              <?php } else if ($f_taste == "Moderate Spicy") {
              ...
              <?php } else if ($f_taste == "Less Spicy") {
...
$rr0 = mysqli_query($conn, $qq0) or die('Query failed!' . mysqli_error($conn));

if (mysqli_num_rows($rr0) != 0) {
?>
              ...
              <tr>
                ...
                <td>
                  <div align="justify">
                    <select name="color_scheme1" id="color_scheme1" onchange="color_scheme(this.value);">
  <?php
  while ($cc0 = mysqli_fetch_array($rr0)) {
    $s_id = $cc0['SCHEME_ID'];
    $qq11 = "SELECT SCHEME_NAME FROM banq_color_scheme WHERE SCHEME_ID = '$s_id'";
    $rr11 = mysqli_query($conn, $qq11) or die('Query failed!' . mysqli_error($conn));
    $cc11 = mysqli_fetch_array($rr11);
  ?>
        ...
        <div id="mid2column_box">
          ...
          <table width="252" border="0">
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="b_rate" type="text" size="10" id="op1" onchange="calc('op','op1','result'); calculate_total('total','grand_tot');" pattern="[0-9]+" value="<?php echo $ans5['b_rate']; ?>" /></div>
              </td>
              <td width="78">
                <div align="justify"><input name="b_rate_total" type="text" size="10" id="result" class="total" readonly="readonly" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['b_rate_total']; ?>" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="hall_rate" type="text" size="10" id="result6" class="total" onchange="calculate_total('total','grand_tot')" pattern="[0-9]+" value="<?php echo $ans5['hall_adv']; ?>" /></div>
              </td>
              <th>
                <div align="right"></div>
              </th>
          ...
          <table width="315">
            ...
            <tr>
              ...
              <td width="45">
                <div align="justify"><input name="drinks" type="text" size="5" id="op2" pattern="[0-9]+" onchange="calc('op2','op3','result1'); calculate_total('total','grand_tot');" value="<?php echo $ans5['Drink_no']; ?>" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="40">
                <div align="justify"><input name="drinks_rate" type="text" size="5" id="op3" pattern="[0-9]+" onchange="calc('op2','op3','result1'); calculate_total('total','grand_tot');" value="<?php echo $ans5['Drink_rate']; ?>" /></div>
              </td>
              <td width="86">
                <div align="right">
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="tea" type="text" size="5" id="op4" pattern="[0-9]+" onchange="calc('op4','op5','result2'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tea_no']; ?>" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="40">
                <div align="justify"><input name="tea_rate" type="text" size="5" id="op5" pattern="[0-9]+" onchange="calc('op4','op5','result2'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tea_rate']; ?>" /></div>
              </td>
              <td width="86">
                <div align="right">
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="water" type="text" size="5" id="op6" pattern="[0-9]+" onchange="calc('op6','op7','result3'); calculate_total('total','grand_tot');" value="<?php echo $ans5['water_no']; ?>" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="40">
                <div align="justify"><input name="water_rate" type="text" size="5" id="op7" pattern="[0-9]+" onchange="calc('op6','op7','result3'); calculate_total('total','grand_tot');" value="<?php echo $ans5['water_rate']; ?>" /></div>
              </td>
              <td width="86">
                <div align="right">
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="tset" type="text" size="5" id="op8" pattern="[0-9]+" onchange="calc1('op8','op9','result4'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tableset_no']; ?>" /></div>
              </td>
              <th width="27">
                <div align="justify">Rate:</div>
              </th>
              <td width="40">
                <div align="justify"><input name="tset_rate" type="text" size="5" pattern="[0-9]+" id="op9" onchange="calc1('op8','op9','result4'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tableset_rate']; ?>" /></div>
              </td>
              <td width="86">
                <div align="right">
          ...
          <table width="221" border="0">
            <tr>
              ...
              <td width="114">
                <div align="justify"><input name="extra" type="text" size="10" id="result5" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['extra']; ?>" /></div>
              </td>
            </tr>
          </table>
          <table width="324" border="0">
            <tr>
              ...
              <td width="51">
                <div align="justify"><input name="tax" type="text" size="5" pattern="[0-9]+" id="tax" onchange="tax_calc(); calculate_total('total','grand_tot');" value="<?php echo $ans5['tax']; ?>" /></div>
              </td>
              <td width="60">
                <div align="justify"><input name="tax_p" type="checkbox" id="tax_p" />%</div>
              </td>
              ...
              <td width="44">
                <div align="justify"><input readonly="readonly" name="tax_percent" type="text" size="5" class="total" id="tax_tot" onchange="calculate_total('total','grand_tot')"
                    value="<?php echo $ans5['tax_total']; ?>" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="ser_charge" id="ser_charge" type="text" size="5" pattern="[0-9]+" onchange=" service_calc(); calculate_total('total','grand_tot');" value="<?php echo $ans5['service']; ?>" /></div>
              </td>
              <td width="60">
                <div align="justify"><input name="ser_p" type="checkbox" id="ser_p" />%</div>
              </td>
              ...
              <td width="44">
                <div align="justify"><input readonly="readonly" name="ser_percent" type="text" size="5" class="total" id="ser_tot" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['service_total']; ?>" /></div>
              </td>
            </tr>
    ...
    <td width="53"><div align="justify"><input name="ser_percent" type="text" size="5" class="total" id="ser_tot" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['service_total']; ?>"/></div></td>
          ...
          <table width="273" border="0">
            <tr>
              ...
              <td width="170">
                <div align="justify"><input name="stage_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['stage_amount']; ?>" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="sound_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['sound_amount']; ?>" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="vid_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['video_amount']; ?>" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="misc_charge" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['misc_amount']; ?>" /></div>
              </td>
            </tr>
            <tr>
              <th>
              ...
              <td>
                <div align="justify"><input name="discount" type="text" size="10" id="discount" pattern="[0-9]+" onchange="calculate_discount('discount','grand_tot')" value="<?php echo $ans5['DISCOUNT_DETAIL']; ?>" /></div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="grand_total" type="text" size="10" id="grand_tot" readonly="readonly" value="<?php echo $ans5['grand_total']; ?>" /></div>
              </td>
            </tr>
          </table>
...
$result21 = mysqli_query($conn, $query21) or die('Selection Failed: ' . mysqli_error($conn));
...
?>
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="adv1" type="text" size="10" pattern="[0-9]+" id="adv1" class="advance" onchange="pass_validation(); generate_cr('ins1'); calculate_total('advance','advance_total'); recieved_amount('adv1','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row21['INSTALMENT_AMOUNT']; ?>" /></div>
              </td>
              <td>
                <div align="justify"><input name="adv_cr1" type="text" size="5" value="<?php echo $row21['CR_NO']; ?>" readonly="readonly" id="ins1" /></div>
              </td>
              <td align="right"><input type="text" name="money" size="10" id="rec_money" onchange=" pass_validation(); recieved_amount1('rec_money','tot_rec'); diff('grand_tot','tot_rec','net'); " /></td>

            </tr>
            <?php
$query22 = "SELECT CR_NO, INSTALMENT_AMOUNT FROM payment_serial_admin WHERE ORDER_ID = '$order_id' AND INSTALMENT_NO = '2'";

$result22 = mysqli_query($conn, $query22) or die('Selection Failed: ' . mysqli_error($conn));
...
?>
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="adv2" type="text" size="10" pattern="[0-9]+" id="adv2" class="advance" onchange=" pass_validation(); generate_cr_admin2('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row22['INSTALMENT_AMOUNT']; ?>" /></div>
              </td>
              <td>
                <div align="justify"><input name="adv_cr2" type="text" size="5" value="<?php echo $row22['CR_NO']; ?>" readonly="readonly" id="ins2" /></div>
              </td>
              <th>
                <div align="justify">Total Recieved</div>
              </th>
...
$result23 = mysqli_query($conn, $query23) or die('Selection Failed: ' . mysqli_error($conn));
...
?>
            ...
            <tr>
              ...
              <td>
                <div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3" class="advance" onchange=" pass_validation(); generate_cr_admin3('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec'); diff('grand_tot','tot_rec','net');" value="<?php echo $row23['INSTALMENT_AMOUNT']; ?>" /></div>
              </td>
              <td>
                <div align="justify"><input name="adv_cr3" type="text" size="5" value="<?php echo $row23['CR_NO']; ?>" readonly="readonly" id="ins3" /></div>
              </td>
        ...
        <div id="thermal_print" style="display:none">


          <table width="500" border="0">

            <tr>
              <div style="width:250px;"><strong>
                  <?php echo $row11['BANQ_NAME'];
                  if ($time_from == "12:00:00" && $time_to == "17:00:00") {
                    echo '&nbsp;(LUNCH)';
                  } else {
                    echo '&nbsp;(DINNER)';
            ...
            <tr>
              <div style="width:500px"><strong>Bill Date: </strong> <?php echo $todayy;  ?></div>
            </tr>

            <tr>
              <div style="width:500px"><strong>Order No: </strong><?php echo $order_id; ?></div>
            </tr>

            <tr>
              <div style="width:500px"><strong>Guest: </strong><?php echo $ans5['GUEST_NAME']; ?></div>
            </tr>

            <tr>
              <div style="width:500px"><strong>Function Date: </strong><?php echo $date_r; ?></div>
            </tr>

            <tr>
              <td><strong>No. of Persons: </strong></td>
              <td><?php echo $ans5['guest_guranteed']; ?></td>
            </tr>

            <tr>
              <td><strong>Hall Rental:</strong> </td>
              <td><?php echo $ans5['hall_adv']; ?></td>
            </tr>

            <tr>
              <td width="100"><strong>Cold Drinks:</strong> </td>
              <td width="50"><?php echo $ans5['Drink_no']; ?></td>
              <td width="40"><strong>Rate:</strong> </td>
              <td width="50"><?php echo $ans5['Drink_rate']; ?></td>
              <td width="40"><strong>Total:</strong> </td>
              <td width="50"><?php echo $ans5['Drink_rate_total']; ?></td>
            </tr>

            <tr>
              <td><strong>Tea:</strong> </td>
              <td><?php echo $ans5['tea_no']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo $ans5['tea_rate']; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['tea_rate_total']; ?></td>
            </tr>

            <tr>
              <td><strong>Mineral Water:</strong> </td>
              <td><?php echo $ans5['water_no']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo $ans5['water_rate']; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['water_rate_total']; ?></td>
            </tr>


            <tr>
              <div style="width:500px">
                <td><strong>Table Setting:</strong> </td>
                <td><?php echo $ans5['tableset_no']; ?></td>
                <td><strong>Rate:</strong> </td>
                <td><?php echo $ans5['tableset_rate']; ?></td>
                <td><strong>Total:</strong> </td>
                <td><?php echo $ans5['tableset_rate_total']; ?></td>
              </div>
            </tr>

            <tr>
              <td><strong>Extras:</strong> </td>
              <td><?php echo $ans5['extra']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo '---'; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['extra']; ?></td>
            ...
            <tr>
              ...
              <td><?php echo $ans5['service']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo '---'; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['service_total']; ?></td>
            </tr>


            <tr>
              <td><strong>Stage Amount:</strong> </td>
              <td><?php echo $ans5['stage_amount']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo '---'; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['stage_amount']; ?></td>
            ...
            <tr>
              <td><strong>Sound Amount:</strong> </td>
              <td><?php echo $ans5['sound_amount']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo '---'; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['sound_amount']; ?></td>
            ...
            <tr>
              <td><strong>Video Amount:</strong> </td>
              <td><?php echo $ans5['video_amount']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo '---'; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['video_amount']; ?></td>
            ...
            <tr>
              <td><strong>Misc Amount:</strong> </td>
              <td><?php echo $ans5['misc_amount']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo '---'; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['misc_amount']; ?></td>
            ...
            <tr>
              ...
              <td><?php echo $ans5['DISCOUNT_DETAIL']; ?></td>
              <td><strong>Rate:</strong> </td>
              <td><?php echo '---'; ?></td>
              <td><strong>Total:</strong> </td>
              <td><?php echo $ans5['DISCOUNT_DETAIL']; ?></td>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td style="font-size:16px"><?php echo $ans5['grand_total']; ?></td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td style="font-size:16px"><strong>Total Received:</strong> </td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td style="font-size:16px"><?php echo $ans5['adv_total']; ?></td>
            </tr>

            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td style="font-size:18px"><strong>Net Payable:</strong> </td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
  ...
  <?php } ?>
            ...
            <tr>
              ...
              <td>
                <h1 style=" font-size:18px; color:#F00;"> Net Payable <input name="net" type="text" size="10" readonly="readonly" id="net" style="font-size:22px; font-weight:900; color:#F00;"
                    value="<?php
                            if ($ans5['adv_total'] != 0) {
                              echo $ans5['grand_total'] - $ans5['adv_total'];
                            } else {
