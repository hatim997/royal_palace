...
<body>
         ...
         <?php
    		$query2 = "SELECT * FROM banq_order_master WHERE FUNCTION_DATE='$date' AND BANQ_ID='$id' AND TIME_FROM='$time_from' AND TIME_TO='$time_to'";
  ...
  <th width="94"><div align="justify">Function Date</div></th>
    <td width="127"><div align="justify">
     <input type="hidden" name="f_date" id="f_date" value="<?php echo $date; ?>"/>
      <input type="text" size="10" name="date1" id="date1" value="<?php echo $date; ?>" onchange="date_check1(this.value);"/>
      <input type="text" size="10" name="date2" id="date2" value="" onchange="addhall();" />
    </div></td></tr>
     <tr>
  <th width="94"><div align="justify">Function Time</div></th>
    <td width="127"><div align="justify">
    <input name="time_from" type="hidden" id="tim" value="<?php echo $time_from; ?>" />
      <select id="func_time" name="time" />
      <?php  if($time_from=="12:00:00" && $time_to =="17:00:00") {?>
      <option value="lunch">Lunch</option>
      <?php } else if($time_from=="18:00:00" && $time_to =="23:00:00") { ?>
      <option value="dinner">Dinner</option> <?php } ?>
      </select> 
    </div></td></tr>
     <tr>
    ...
    <td width="127">
      <div align="justify">
        <select id="banquet" name="banquet">
        <?php
         $query12 = "SELECT * FROM banq_master_tab WHERE BANQ_ID='$id'";
...
<td><div align="justify">
  <input name="guest_gaurante" type="text" size="10" id="g_grn" onchange="same_amount('g_grn','op','op8');"/>
</div></td></tr>
<tr>
...
<table width="300" border="0" >
  ...
  <th width="149"><div align="justify">No. of Person</div></th>
    <td width="65"><div align="justify">
      <input type="text" size="10" name="person" id="op" onchange="calc('op','op1','result'); same_amount('op','g_grn','op8'); calculate_total('total','grand_tot');" pattern="[0-9]+" />
    </div></td>
  </tr>
    <tr>
  ...
  <th height="24"><div align="justify">Table Setting</div></th>
    <td><div align="justify"><input name="tset" type="text" size="5" id="op8" pattern="[0-9]+" onchange="same_amount('op8','op','g_grn'); calc('op8','op9','result4'); calculate_total('total','grand_tot');"/></div></td>
    <th width="27"><div align="justify">Rate:</div></th>
    <td width="30"><div align="justify"><input name="tset_rate" type="text" size="5" pattern="[0-9]+" id="op9" onchange="calc('op8','op9','result4'); calculate_total('total','grand_tot');"/></div></td>
    <td width="47"><div align="right">
  ...
  <table width="324" border="0">
   ...
   <tr>
  <th width="151"><div align="justify">Tax</div></th>
    ...
    <td width="44"><div align="justify"><input name="tax_percent" type="text" size="5" class="total" id="tax_tot" onchange="calculate_total('total','grand_tot')"/></div></td>
  </tr>
   <tr>
  <th><div align="justify">Service Charges</div></th>
    ...
    <td width="44"><div align="justify"><input name="ser_percent" type="text" size="5" class="total" id="ser_tot" onchange="calculate_total('total','grand_tot')"/></div></td>
  </tr>
   </table>
   <table width="231" border="0">
   <tr>
  ...
  <th><div align="justify" class="red1">Grand Total</div></th>
   ...
   <table width="277">
   <tr>
   <td width="17"><div align="justify"></div></td><th width="88"><div align="justify">Advance Rs.</div></th><th width="39"><div align="justify">CR #</div></th>
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv2" type="text" size="10" pattern="[0-9]+" id="adv2"   class="advance" onchange=" generate_cr('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec');"/></div></td>
 ...
 <th><div align="justify">Total Recieved</div></th>
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3"   class="advance" onchange=" generate_cr('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec');"/></div></td>
...
<?php
$query5 ="SELECT * FROM dish_master_tab";
...
<input name="today" type="hidden" id="today" value="<?php echo $tdate; ?>" />
  ...
  <th width="86"><div align="justify">Function*</div></th>
    ...
    <td width="139"><div align="justify">
      ...
      <input type="text" size="10" name="date1"  id="date1" value="<?php echo $date_r=$aa['FUNCTION_DATE']; ?>" onchange="date_check1(this.value);"/>
      <input type="text" size="10" name="date2"  id="date2" value=""  onchange="addhall();"/>
      <?php
      } 
	  $add_date="";
  ...
  <th width="86"><div align="justify">Function Time</div></th>
    ...
    <td width="139">
      <div align="justify">
        <select id="banquet" name="banquet">
        <?php
         $query12 = "SELECT banq_master_tab.BANQ_ID, banq_master_tab.BANQ_NAME FROM banq_master_tab,banq_order_master 
		 WHERE banq_order_master.ORDER_NO = '$order_id' AND banq_order_master.FUNCTION_DATE = '$date_r' AND banq_order_master.BANQ_ID='$id' AND  banq_master_tab.BANQ_ID='$id'";
            $result12 = mysql_query($query12);
			while($row=mysql_fetch_array($result12))
			{
			?>
...
<th><div align="justify">Guest Guranted</div></th>
<td><div align="justify">
  <input name="guest_gaurante" type="text" size="10" id="g_grn" value="<?php echo $ans5['guest_guranteed']; ?>" onchange="same_amount('g_grn','op','op8');"/>
</div></td></tr>
<tr>
<th><div align="justify">Function Incharge</div></th>
<td><div align="justify">
...
<th><div align="justify">Order Dishes</div></th>
<td>
<select style="width:200px; font-size:12px" name="menu_order[]" id="menu_order1" size="9" multiple="multiple">
<?php
...
<table width="252" border="0" >
  ...
  <th width="93"><div align="justify">No. of Person</div></th>
    <td width="67"><div align="justify">
      <input type="text" size="10" name="person" id="op" onchange="calc('op','op1','result'); same_amount('op','g_grn','op8'); calculate_total('total','grand_tot');" pattern="[0-9]+" value="<?php echo $ans5['guest_guranteed']; ?>"/>
    </div></td>
  </tr>
    <tr>
  <th><div align="justify">B. rate</div></th>
  ...
  <th width="93"><div align="justify">Cold Drinks</div></th>
    <td width="45"><div align="justify"><input name="drinks" readonly="readonly" type="text" size="5" id="op2" pattern="[0-9]+" onchange="calc('op2','op3','result1'); calculate_total('total','grand_tot');" value="<?php echo $ans5['Drink_no']; ?>"/></div></td>
    <th width="27"><div align="justify">Rate:</div></th>
    <td width="40"><div align="justify"><input name="drinks_rate" readonly="readonly" type="text" size="5" id="op3" pattern="[0-9]+" onchange="calc('op2','op3','result1'); calculate_total('total','grand_tot');" value="<?php echo $ans5['Drink_rate']; ?>"/></div></td>
   ...
   <tr>
  <th><div align="justify">Tea</div></th>
    <td><div align="justify"><input name="tea" readonly="readonly" type="text" size="5" id="op4" pattern="[0-9]+" onchange="calc('op4','op5','result2'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tea_no']; ?>"/></div></td>
    <th width="27"><div align="justify">Rate:</div></th>
    <td width="40"><div align="justify"><input name="tea_rate" readonly="readonly" type="text" size="5" id="op5" pattern="[0-9]+" onchange="calc('op4','op5','result2'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tea_rate']; ?>"/></div></td>
    <td width="86"><div align="right">
   ...
   <tr>
  <th><div align="justify">Mineral Water</div></th>
    <td><div align="justify"><input name="water" readonly="readonly" type="text" size="5"  id="op6" pattern="[0-9]+" onchange="calc('op6','op7','result3'); calculate_total('total','grand_tot');" value="<?php echo $ans5['water_no']; ?>"/></div></td>
    <th width="27"><div align="justify">Rate:</div></th>
    <td width="40"><div align="justify"><input name="water_rate" readonly="readonly" type="text" size="5" id="op7" pattern="[0-9]+" onchange="calc('op6','op7','result3'); calculate_total('total','grand_tot');" value="<?php echo $ans5['water_rate']; ?>"/></div></td>
    <td width="86"><div align="right">
   ...
   <tr>
  <th height="24"><div align="justify">Table Setting</div></th>
    <td><div align="justify"><input name="tset" readonly="readonly" type="text" size="5" id="op8" pattern="[0-9]+" onchange="calc('op8','op9','result4'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tableset_no']; ?>"/></div></td>
    <th width="27"><div align="justify">Rate:</div></th>
    <td width="40"><div align="justify"><input name="tset_rate" readonly="readonly" type="text" size="5" pattern="[0-9]+" id="op9" onchange="calc('op8','op9','result4'); calculate_total('total','grand_tot');" value="<?php echo $ans5['tableset_rate']; ?>"/></div></td>
    <td width="86"><div align="right">
  ...
  <th width="97"><div align="justify">Extras</div></th>
    <td width="114"><div align="justify"><input name="extra" readonly="readonly"  type="text" size="10" id="result5" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['extra']; ?>"/></div></td>
  </tr>
  </table>
  ...
  <th width="93"><div align="justify">Tax</div></th>
    ...
    <td width="61"><div align="justify"><input name="tax" readonly="readonly" type="text" size="10" pattern="[0-9]+" id="tax" onchange="tax_calc(); calculate_total('total','grand_tot');" value="<?php echo $ans5['tax']; ?>"/></div></td>
    <td width="50"><div align="justify"><input name="tax_p"  type="checkbox" id="tax_p" />%</div></td>
    <td width="53"><div align="justify"><input name="tax_percent" readonly="readonly" type="text" size="5" class="total" id="tax_tot" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['tax_total']; ?>"/></div></td>
  </tr>
   <tr>
  <th><div align="justify">Service Charges</div></th>
    <td><div align="justify"><input name="ser_charge" readonly="readonly" id="ser_charge" type="text" size="5" pattern="[0-9]+" onchange=" service_calc(); calculate_total('total','grand_tot');" value="<?php echo $ans5['service']; ?>" /></div></td>
     <td width="50"><div align="justify"><input name="ser_p"  type="checkbox" id="ser_p" />%</div></td>
    <td width="53"><div align="justify"><input name="ser_percent" readonly="readonly" type="text" size="5" class="total" id="ser_tot" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['service_total']; ?>"/></div></td>
  </tr>
   </table>
   <table width="273" border="0">
   <tr>
  <th width="93"><div align="justify">Stage Amount</div></th>
    <td width="170"><div align="justify"><input name="stage_charge" readonly="readonly" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['stage_amount']; ?>"/></div></td>
  </tr>
   <tr>
  <th><div align="justify">Sound Amount</div></th>
    <td><div align="justify"><input name="sound_charge" readonly="readonly" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['sound_amount']; ?>"/></div></td>
  </tr>
   <tr>
  <th><div align="justify">Video Amount</div></th>
    <td><div align="justify"><input name="vid_charge" readonly="readonly" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['video_amount']; ?>"/></div></td>
  </tr>
   <tr>
  <th><div align="justify">Misc Amount</div></th>
    <td><div align="justify"><input name="misc_charge" readonly="readonly" type="text" size="10" class="total" pattern="[0-9]+" onchange="calculate_total('total','grand_tot')" value="<?php echo $ans5['misc_amount']; ?>"/></div></td>
  </tr>
   <tr>
  <th><div align="justify">Discount</div></th>
    <td><div align="justify"><input name="discount" readonly="readonly" type="text" size="10" id="discount" pattern="[0-9]+" onchange="calculate_discount('discount','grand_tot')" value="<?php echo $ans5['DISCOUNT_DETAIL']; ?>"/></div></td>
  </tr>
...
$result21= mysql_query($query21) or die('Selection Failed:'.mysql_error());	
  ...
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv1" type="text" size="10"  pattern="[0-9]+" id="adv1"  class="advance" onchange=" generate_cr('ins1'); calculate_total('advance','advance_total'); recieved_amount('adv1','tot_rec');" value="<?php echo $row21['INSTALMENT_AMOUNT']; ?>"/></div></td>
    <td><div align="justify"><input name="adv_cr1" type="text" size="5" value="<?php echo $row21['CR_NO']; ?>" readonly="readonly" id="ins1" /></div></td>
  <td align="right"><input name="money" type="text" size="10" id="rec_money" onchange=" pass_validation(); recieved_amount('rec_money','tot_rec'); diff('grand_tot','tot_rec','net'); "/></td>
  
  </tr> 
  <?php
  $query22="SELECT CR_NO,INSTALMENT_AMOUNT FROM payment_serial WHERE ORDER_ID = '$order_id' AND INSTALMENT_NO = '2'";

$result22= mysql_query($query22) or die('Selection Failed:'.mysql_error());	
  $row22=mysql_fetch_array($result22);
  ?>
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv2" type="text" size="10"  pattern="[0-9]+" id="adv2"  class="advance" onchange=" generate_cr('ins2'); calculate_total('advance','advance_total'); recieved_amount('adv2','tot_rec');" value="<?php echo $row22['INSTALMENT_AMOUNT']; ?>"/></div></td>
    <td><div align="justify"><input name="adv_cr2" type="text" size="5" value="<?php echo $row22['CR_NO']; ?>" readonly="readonly" id="ins2" /></div></td>
 <th><div align="justify">Total Recieved</div></th>
  </tr> 
  <?php
  $query23="SELECT CR_NO,INSTALMENT_AMOUNT FROM payment_serial WHERE ORDER_ID = '$order_id' AND INSTALMENT_NO = '3'";

$result23= mysql_query($query23) or die('Selection Failed:'.mysql_error());	
  $row23=mysql_fetch_array($result23);
  ?>
  <tr><th><div align="justify">CF:</div></th>
    <td><div align="justify"><input name="adv3" type="text" size="10" pattern="[0-9]+" id="adv3"  class="advance" onchange=" generate_cr('ins3'); calculate_total('advance','advance_total'); recieved_amount('adv3','tot_rec');" value="<?php echo $row23['INSTALMENT_AMOUNT']; ?>"/></div></td>
...
<?php } ?>
  ...
  <td><h1 style=" font-size:18px; color:#F00;"> Net Payable <input name="net" type="text" size="10" readonly="readonly" id="net" style="font-size:22px; font-weight:900; color:#F00;" value="<?php echo $ans5['DIFFERENCE_AMOUNT']?>" /></h1></td>
  </tr>
</table>
</div>
