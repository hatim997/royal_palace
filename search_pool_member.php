        ...
        <form>
            ...
            <table width="719">
                <tr>
                    ...
                    <td width="139"><input type="button" value="Search" onclick="search_member_pool();" style="background: #FFFFD2; color:#000; height:35px; width:85px; font-size:16px; font-weight:600; border:groove; border-color:#CCC;" /></td>
