<?php session_start(); ?>
<?php
//include('All Applications from server 4/update_activity.php');
...
<link href="All Applications from server 4/templatemo_style16.css" rel="stylesheet" type="text/css" />
...
.load{
background-image:url(All%20Applications%20from%20server%204/images/loader.gif);
...
<script src="All Applications from server 4/Scripts/AC_RunActiveContent.js" type="text/javascript"></script>
...
<form id="form" action="All Applications from server 4/add_manual_dish.php">
		<div id="suggest"><strong>Add Dish:</strong>
			...
			<div id="suggestions" class="suggestionsBox" style="display: none;">
					 <img style="position: relative; top: -12px; left: 120px;" src="All Applications from server 4/images/arrow.png" alt="upArrow" />
				<div id="suggestionsList" class="suggestionList">
                </div>
			</div>
...
<a href=javascript:close_new_Popup()><img width=25 height=25  align="right" SRC=All Applications from server 4/images/remove.png alt=Delete/></a>
<div id="data_popup" >
</div>
</div>
