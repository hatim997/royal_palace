...
<div id="form_container">
	<div id="mydiv">
		<img src="images/header_report.jpg" width="998" height="210" />
		<form id="form1" class="appnitro" enctype="multipart/form-data" method="post" action="">

			<div class="form_description" align="center">
				<h2>Swimming Pool - Membership Registration Form</h2>
				<p>&nbsp;</p>
			</div>
			...
			<table width="945" background="images/watermark1.png">
				...
				<tr>
					...
					<td width="201">
						...
						?>
							<input name="1" type="text" value="<?php echo $swimmer_detail; ?>" />
						<?php
							$i++;
						} ?>
				...
				<tr>
					...
					<td>
						...
						$query1 = "SELECT * FROM POOL_MEMBERSHIP_PERIOD_TAB WHERE MEMBER_PERIOD_ID = '$m_id'";
				...
				<tr>
					...
					<td><textarea name="ad" cols="20" rows="4"><?php echo $address; ?></textarea>
			...
			<table width="947" background="images/watermark1.png">
				<tr>
					<td width="189">
			...
			<table width="412">
				<tr>
					...
					<td width="214" background="images/watermark1.png">
	...
	<div id="bottomcolumn_box">
		...
		<input name="exit" type="button" value="Exit" style="background:#91400F; height:30px; width:115px; font-weight:700;" onclick="window.location.href='pool_reg_form.php'" />
	</div>
