...
<body onclick="clicked=true;" onbeforeunload="CheckBrowser()">
	<div id="templatemo_container">
		...
		<div id="templatemo_content">
          ...
          INNER JOIN store_master_tab ON restaurant_inventory.INGREDIENT_ID = store_master_tab.INGREDIENT_ID
          INNER JOIN restaurant_demand ON restaurant_demand.INGREDIENT_ID = restaurant_inventory.INGREDIENT_ID
          WHERE restaurant_demand.DEMAND_NO = '$demandno'
