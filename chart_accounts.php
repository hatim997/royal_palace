				...
				<table width="1237" align="left" border="0">
					<tr>
						<td width="366" align="left">
							<h1 class="style1" style=" font-size:16px;"><u>Chart of Accounts</u></h1>
						</td>
						<td width="410" align="center">
							<h2 class="style1" style=" font-size:16px; font-style:italic;"><u>View All</u></h2>
						</td>
						<td width="458" align="right"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100" height="25">
						...
						<table width="1237" align="left" border="0">
							<tr>
								<td width="127" align="left">
									<h2 class="style1" style=" font-size:16px; font-style:italic;"><u>Add New</u></h2>
								</td>
						...
						<table width="1200" cellpadding="0" cellspacing="0" BORDER=1 RULES=NONE FRAME=BOX>
							...
							<tr style="height:50px;">
								...
								<td width="148"><a href="javascript:save_form()" alt="Add" title="Add"><img src="images/add.png" alt="Add" /></a>&nbsp;
									<a href="javascript:refresh_form()" alt="Refresh" title="Refresh"><img src="images/refresh.png" alt="Refresh" /></a>
								</td>
							</tr>
						</table>
