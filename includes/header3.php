...
</div><div id="templatemo_menu" style="background:url(images/dock-bg.png); width:1001px; height: 47px;"><div class="dock" id="dock">
  <div class="dock-container">
	  <a class="dock-item" href="login.php" ><img src="images/home.png" alt="home" /><span>Home</span></a> 
	  <a class="dock-item" href="#"><img src="images/forum.png" style="padding-left: 10px;" alt="forum" /><span>&nbsp;&nbsp;Forum</span></a> 
	  ...
	  <a class="dock-item" href="#"><img src="images/tell us.png" style="padding-left: 40px;" alt="Case Guide" /><span style=" width: 90px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Case Guide</span></a> 
	  <a class="dock-item" href="#"><img src="images/membership.png" style="padding-left: 50px;" alt="membership" /><span style=" width: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Membership</span></a>  
	    </div> 
