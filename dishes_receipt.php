...
<head>
  ...
  <script type="text/javascript">
    function printSelection(node) {
      ...
      var pwin = window.open('', 'print_content', 'width=800,height=650');
...
<div id="templatemo_content">
  ...
  <div id="mydiv1">
    <div id="mydiv">
      ...
      <img src="images/logo.png" width="515" height="165" />
      <table width="533" frame="hsides">
        ...
        <tr>
          <th width="77">
            <div align="justify">Receipt #</div>
          </th>
          <td width="178">
            <div align="justify"><?php echo $adv_cr3; ?></div>
          </td>
          <th width="121">
          ...
          <td width="250" align="left">
            <div align="justify">
              ...
              <p>
                ...
                $r3_1 = mysqli_query($conn, $q3_1) or die('Query Failed: ' . mysqli_error($conn));
    ...
    <td><div align="justify">
      <p><?php $guest_guranted; ?>     </p>
        ...
        <tr>
          <th>
            <div align="justify">Total Charges</div>
          </th>
          <td>
            <div align="justify">
              <p><?php echo $received_amount + $net; ?></p>
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <th>
            <div align="justify">Payable Amount</div>
          </th>
          <td>
            <div align="justify">
              <p><?php echo $net; ?></p>
              ...
              <p>
                ...
                ?>
                  ...
                  <?php echo $row['BANQ_NAME']; ?></br> <?php } ?> <?php
                                                                    //ADDITIONAL HALLS
                                                                    $q4 = "SELECT BANQ_ID FROM banq_order_master WHERE ORDER_NO='$order_id' AND FUNCTION_DATE='$function_date'";
                                                                    $r4 = mysqli_query($conn, $q4) or die("Query Failed: " . mysqli_error($conn));
                                                                    ...
                                                                    if ($num > 1) { ?> <?php
                                                                                        foreach ($_POST['add_hall'] as $hall) {
                                                                                          $query12 = "SELECT DISTINCT BANQ_NAME FROM banq_master_tab WHERE BANQ_ID='$hall'";
                                                                                          $result12 = mysqli_query($conn, $query12) or die("Query Failed: " . mysqli_error($conn));
  ...
  <div>
    <p></p>
    <input name="print" type="submit" value="Print Out" onclick="printSelection(document.getElementById('mydiv1'));return false" style="background: #F30; color:#000; height:35px; width:85px; font-size:16px; font-weight:600; border:groove; border-color:#CCC;" />
