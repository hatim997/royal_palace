  ...
  -->
        ...
        <li><a class="MenuBarItemSubmenu" href="#">Dish Management</a>
          <ul>
            ...
            <li><a href="rpt_banq_collection.php">Banquet Collection Report</a></li>
            <!--  <li><a href="view_reqs.php">View Requisitions</a></li> -->
          </ul>
        </li>
    ...
    <form name="form1" id="form1" method="post" action="reception_book.php">
      <div id="templatemo_content2">
        <!--<h1 align="justify"><span class="style3"><?php // echo $todayy." ".$day; 
                                                      ?></span></h1>-->
        <h1 &nbsp;&nbsp;><span class="style3"><?php echo $today; ?></span></h1>
        <h1 &nbsp;&nbsp; class="red" style=" font-size:16px;"><span style="text-align: left">
          </span>Welcome <BLINK><?php echo $userid; ?></BLINK>
        </h1>

        <!--<h1 align="justify" class="red" style=" font-size:16px;"><span style="text-align: left"></span>Welcome <BLINK><?php //echo $_SESSION['username']; 
                                                                                                                          ?></BLINK></h1>-->
        <div align="justify">
          ...
          <table width="800" border="0" cellpadding="0" cellspacing="0" style="">
            ...
            <td width="489" align="left" style="text-align: justify">
              <p align="center">
                ...
                <?php
                //$tdate = mktime(+5,0,0,date("m"),date("d"),date("Y"));
                // $acc_date	  = date("Y-m-d", mktime(date("H")+5, 0, 0, date("m"), date("d"), date("Y")));
                // It is from "time_calculation.php"

                ?>
                <input type="text" name="date" style="border:groove" id="date" value="<?php echo $date = date($acc_date); ?>" onchange="search_slot();" />
          ...
          <div id="entry">
            <table width="800" border="0" cellpadding="0" cellspacing="0" style="">
              ...
              <tr>
                <th width="180" valign="top" style="text-align: justify">
                  <div align="center">Lunch</div>
                </th>
                <td width="620" style="text-align: justify">
                  <div align="left">
                    ...
                    while ($row = mysqli_fetch_array($result1)) {
                      ...
                      if ($row && $row2 && $row['BANQ_ID'] == $row2['BANQ_ID']) {
