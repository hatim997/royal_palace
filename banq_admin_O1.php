  ...
  -->
      <li><a class="MenuBarItemSubmenu" href="#">Banquet</a>
        <ul>
          ...
          <li><a href="rpt_banq_sale.php">Banquet Sales Report</a></li>
          <?php /*?><li><a href="rpt_sale_summary.php">Sale Summary Report</a></li>
      <li><a href="rpc1.php">RPC</a></li>
      <li><a href="rpt_revenue_collection.php">Revenue Collection</a></li>
      <li><a href="rpt_ost_revenue.php">OST Revenue</a></li>
      <li><a href="rpt_daily_rev_collection.php">Daily Revenue Collection</a></li>
      <?php */ ?>
        </ul>
      </li>
