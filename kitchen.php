				...
				<div id="leftcolumn_box01">
					...
					<div class="leftcolumn_box01_bottom">
						<div id="menu2" class="form_row">
							<ul>
								<li><a href="kitchen_order.php">Orders</a></li>
								<li><a href="dish_master.php">Add New Dish</a></li>
								<li><a href="new_dish_recipe.php">Dish Recipe</a></li>
								<li><a href="dish_recipe_new.php">Dish Recipe New</a></li>
								<li><a href="recipe_edit.php">Edit Recipe</a></li>
